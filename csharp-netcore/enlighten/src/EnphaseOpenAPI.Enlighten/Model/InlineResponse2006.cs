...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2006 : IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(int systemId = default(int), List<InlineResponse2006MeterReadings> meterReadings = default(List<InlineResponse2006MeterReadings>), Meta meta = default(Meta))
        {
            this.SystemId = systemId;
            // to ensure "meterReadings" is required (not null)
            this.MeterReadings = meterReadings ?? throw new ArgumentNullException("meterReadings is a required property for InlineResponse2006 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2006 and cannot be null");
        }
        ...
        public List<InlineResponse2006MeterReadings> MeterReadings { get; set; }
