...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InventoryResponse_envoys")]
    public partial class InventoryResponseEnvoys : IEquatable<InventoryResponseEnvoys>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryResponseEnvoys" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InventoryResponseEnvoys() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryResponseEnvoys" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventoryResponseEnvoys {\n");
        ...
        {
            return this.Equals(input as InventoryResponseEnvoys);
        }

        /// <summary>
        /// Returns true if InventoryResponseEnvoys instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryResponseEnvoys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryResponseEnvoys input)
        {
            if (input == null)
                return false;
