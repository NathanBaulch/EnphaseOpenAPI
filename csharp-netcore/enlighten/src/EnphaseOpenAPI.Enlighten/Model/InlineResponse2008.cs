...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2008 : IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<InlineResponse2008Intervals> intervals = default(List<InlineResponse2008Intervals>))
        {
            this.SystemId = systemId;
            this.TotalDevices = totalDevices;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2008 and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for InlineResponse2008 and cannot be null");
        }
        ...
        public List<InlineResponse2008Intervals> Intervals { get; set; }
