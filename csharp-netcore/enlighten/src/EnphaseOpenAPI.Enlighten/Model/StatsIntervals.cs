...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// StatsIntervals
    /// </summary>
    [DataContract(Name = "Stats_intervals")]
    public partial class StatsIntervals : IEquatable<StatsIntervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatsIntervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatsIntervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatsIntervals" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatsIntervals {\n");
        ...
        {
            return this.Equals(input as StatsIntervals);
        }

        /// <summary>
        /// Returns true if StatsIntervals instances are equal
        /// </summary>
        /// <param name="input">Instance of StatsIntervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatsIntervals input)
        {
            if (input == null)
                return false;
