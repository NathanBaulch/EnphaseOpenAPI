...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsumptionStatsResponse_intervals")]
    public partial class ConsumptionStatsResponseIntervals : IEquatable<ConsumptionStatsResponseIntervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionStatsResponseIntervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsumptionStatsResponseIntervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionStatsResponseIntervals" /> class.
        /// </summary>
        ...
        public ConsumptionStatsResponseIntervals(long endAt = default(long), int enwh = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.Enwh = enwh;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumptionStatsResponseIntervals {\n");
        ...
        {
            return this.Equals(input as ConsumptionStatsResponseIntervals);
        }

        /// <summary>
        /// Returns true if ConsumptionStatsResponseIntervals instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsumptionStatsResponseIntervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumptionStatsResponseIntervals input)
        {
            if (input == null)
            {
                return false;
