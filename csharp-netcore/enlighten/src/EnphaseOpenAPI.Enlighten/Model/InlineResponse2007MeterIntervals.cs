...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_7_meter_intervals")]
    public partial class InlineResponse2007MeterIntervals : IEquatable<InlineResponse2007MeterIntervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007MeterIntervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2007MeterIntervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007MeterIntervals" /> class.
        /// </summary>
        ...
        public InlineResponse2007MeterIntervals(string meterSerialNumber = default(string), string envoySerialNumber = default(string), List<InlineResponse2007Intervals1> intervals = default(List<InlineResponse2007Intervals1>))
        {
            // to ensure "meterSerialNumber" is required (not null)
            this.MeterSerialNumber = meterSerialNumber ?? throw new ArgumentNullException("meterSerialNumber is a required property for InlineResponse2007MeterIntervals and cannot be null");
            // to ensure "envoySerialNumber" is required (not null)
            this.EnvoySerialNumber = envoySerialNumber ?? throw new ArgumentNullException("envoySerialNumber is a required property for InlineResponse2007MeterIntervals and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for InlineResponse2007MeterIntervals and cannot be null");
        }
        ...
        public List<InlineResponse2007Intervals1> Intervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007MeterIntervals {\n");
        ...
        {
            return this.Equals(input as InlineResponse2007MeterIntervals);
        }

        /// <summary>
        /// Returns true if InlineResponse2007MeterIntervals instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007MeterIntervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007MeterIntervals input)
        {
            if (input == null)
                return false;
