...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_1_envoys")]
    public partial class InlineResponse2001Envoys : IEquatable<InlineResponse2001Envoys>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Envoys" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2001Envoys() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Envoys" /> class.
        /// </summary>
        ...
        public InlineResponse2001Envoys(int envoyId = default(int), int lastReportAt = default(int), string name = default(string), string partNumber = default(string), string serialNumber = default(string), StatusEnum status = default(StatusEnum))
        {
            this.EnvoyId = envoyId;
            this.LastReportAt = lastReportAt;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineResponse2001Envoys and cannot be null");
            // to ensure "partNumber" is required (not null)
            this.PartNumber = partNumber ?? throw new ArgumentNullException("partNumber is a required property for InlineResponse2001Envoys and cannot be null");
            // to ensure "serialNumber" is required (not null)
            this.SerialNumber = serialNumber ?? throw new ArgumentNullException("serialNumber is a required property for InlineResponse2001Envoys and cannot be null");
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2001Envoys {\n");
        ...
        {
            return this.Equals(input as InlineResponse2001Envoys);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Envoys instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Envoys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Envoys input)
        {
            if (input == null)
                return false;
