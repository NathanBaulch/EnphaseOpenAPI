...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvertersSummaryByEnvoyOrSite_micro_inverters")]
    public partial class InvertersSummaryByEnvoyOrSiteMicroInverters : IEquatable<InvertersSummaryByEnvoyOrSiteMicroInverters>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvertersSummaryByEnvoyOrSiteMicroInverters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvertersSummaryByEnvoyOrSiteMicroInverters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvertersSummaryByEnvoyOrSiteMicroInverters" /> class.
        /// </summary>
        ...
        public InvertersSummaryByEnvoyOrSiteMicroInverters(int id = default(int), string model = default(string), string partNumber = default(string), string serialNumber = default(string), string sku = default(string), StatusEnum status = default(StatusEnum), int powerProduced = default(int), string procLoad = default(string), string paramTable = default(string), string envoySerialNumber = default(string), InvertersSummaryByEnvoyOrSiteEnergy energy = default(InvertersSummaryByEnvoyOrSiteEnergy), string gridProfile = default(string), DateTime lastReportDate = default(DateTime))
        {
            this.Id = id;
            // to ensure "model" is required (not null)
            this.Model = model ?? throw new ArgumentNullException("model is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "partNumber" is required (not null)
            this.PartNumber = partNumber ?? throw new ArgumentNullException("partNumber is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "serialNumber" is required (not null)
            this.SerialNumber = serialNumber ?? throw new ArgumentNullException("serialNumber is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "sku" is required (not null)
            this.Sku = sku ?? throw new ArgumentNullException("sku is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            this.Status = status;
            this.PowerProduced = powerProduced;
            // to ensure "procLoad" is required (not null)
            this.ProcLoad = procLoad ?? throw new ArgumentNullException("procLoad is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "paramTable" is required (not null)
            this.ParamTable = paramTable ?? throw new ArgumentNullException("paramTable is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "envoySerialNumber" is required (not null)
            this.EnvoySerialNumber = envoySerialNumber ?? throw new ArgumentNullException("envoySerialNumber is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "energy" is required (not null)
            this.Energy = energy ?? throw new ArgumentNullException("energy is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
            // to ensure "gridProfile" is required (not null)
            this.GridProfile = gridProfile ?? throw new ArgumentNullException("gridProfile is a required property for InvertersSummaryByEnvoyOrSiteMicroInverters and cannot be null");
        ...
        public InvertersSummaryByEnvoyOrSiteEnergy Energy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvertersSummaryByEnvoyOrSiteMicroInverters {\n");
        ...
        {
            return this.Equals(input as InvertersSummaryByEnvoyOrSiteMicroInverters);
        }

        /// <summary>
        /// Returns true if InvertersSummaryByEnvoyOrSiteMicroInverters instances are equal
        /// </summary>
        /// <param name="input">Instance of InvertersSummaryByEnvoyOrSiteMicroInverters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvertersSummaryByEnvoyOrSiteMicroInverters input)
        {
            if (input == null)
                return false;
