...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_4_micro_inverters")]
    public partial class InlineResponse2004MicroInverters : IEquatable<InlineResponse2004MicroInverters>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004MicroInverters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2004MicroInverters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004MicroInverters" /> class.
        /// </summary>
        ...
        public InlineResponse2004MicroInverters(int id = default(int), string model = default(string), string partNumber = default(string), string serialNumber = default(string), string sku = default(string), StatusEnum status = default(StatusEnum), int powerProduced = default(int), string procLoad = default(string), string paramTable = default(string), string envoySerialNumber = default(string), InlineResponse2004Energy energy = default(InlineResponse2004Energy), string gridProfile = default(string), DateTime lastReportDate = default(DateTime))
        {
            this.Id = id;
            // to ensure "model" is required (not null)
            this.Model = model ?? throw new ArgumentNullException("model is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "partNumber" is required (not null)
            this.PartNumber = partNumber ?? throw new ArgumentNullException("partNumber is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "serialNumber" is required (not null)
            this.SerialNumber = serialNumber ?? throw new ArgumentNullException("serialNumber is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "sku" is required (not null)
            this.Sku = sku ?? throw new ArgumentNullException("sku is a required property for InlineResponse2004MicroInverters and cannot be null");
            this.Status = status;
            this.PowerProduced = powerProduced;
            // to ensure "procLoad" is required (not null)
            this.ProcLoad = procLoad ?? throw new ArgumentNullException("procLoad is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "paramTable" is required (not null)
            this.ParamTable = paramTable ?? throw new ArgumentNullException("paramTable is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "envoySerialNumber" is required (not null)
            this.EnvoySerialNumber = envoySerialNumber ?? throw new ArgumentNullException("envoySerialNumber is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "energy" is required (not null)
            this.Energy = energy ?? throw new ArgumentNullException("energy is a required property for InlineResponse2004MicroInverters and cannot be null");
            // to ensure "gridProfile" is required (not null)
            this.GridProfile = gridProfile ?? throw new ArgumentNullException("gridProfile is a required property for InlineResponse2004MicroInverters and cannot be null");
        ...
        public InlineResponse2004Energy Energy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004MicroInverters {\n");
        ...
        {
            return this.Equals(input as InlineResponse2004MicroInverters);
        }

        /// <summary>
        /// Returns true if InlineResponse2004MicroInverters instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004MicroInverters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004MicroInverters input)
        {
            if (input == null)
                return false;
