...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// SystemsSystems
    /// </summary>
    [DataContract(Name = "Systems_systems")]
    public partial class SystemsSystems : IEquatable<SystemsSystems>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemsSystems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SystemsSystems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemsSystems" /> class.
        /// </summary>
        ...
        public SystemsSystems(int systemId = default(int), string systemName = default(string), string systemPublicName = default(string), string reference = default(string), List<string> otherReferences = default(List<string>), string country = default(string), string state = default(string), string city = default(string), string postalCode = default(string), string timezone = default(string), ConnectionType connectionType = default(ConnectionType), StatusEnum status = default(StatusEnum), Meta meta = default(Meta))
        {
            this.SystemId = systemId;
            // to ensure "systemName" is required (not null)
            this.SystemName = systemName ?? throw new ArgumentNullException("systemName is a required property for SystemsSystems and cannot be null");
            // to ensure "systemPublicName" is required (not null)
            this.SystemPublicName = systemPublicName ?? throw new ArgumentNullException("systemPublicName is a required property for SystemsSystems and cannot be null");
            // to ensure "reference" is required (not null)
            this.Reference = reference ?? throw new ArgumentNullException("reference is a required property for SystemsSystems and cannot be null");
            // to ensure "otherReferences" is required (not null)
            this.OtherReferences = otherReferences ?? throw new ArgumentNullException("otherReferences is a required property for SystemsSystems and cannot be null");
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for SystemsSystems and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for SystemsSystems and cannot be null");
            // to ensure "city" is required (not null)
            this.City = city ?? throw new ArgumentNullException("city is a required property for SystemsSystems and cannot be null");
            // to ensure "postalCode" is required (not null)
            this.PostalCode = postalCode ?? throw new ArgumentNullException("postalCode is a required property for SystemsSystems and cannot be null");
            // to ensure "timezone" is required (not null)
            this.Timezone = timezone ?? throw new ArgumentNullException("timezone is a required property for SystemsSystems and cannot be null");
            this.ConnectionType = connectionType;
            this.Status = status;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for SystemsSystems and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemsSystems {\n");
        ...
        {
            return this.Equals(input as SystemsSystems);
        }

        /// <summary>
        /// Returns true if SystemsSystems instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemsSystems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemsSystems input)
        {
            if (input == null)
                return false;
