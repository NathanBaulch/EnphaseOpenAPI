...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RgmStatsResponse_intervals")]
    public partial class RgmStatsResponseIntervals : IEquatable<RgmStatsResponseIntervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsResponseIntervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RgmStatsResponseIntervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsResponseIntervals" /> class.
        /// </summary>
        ...
        public RgmStatsResponseIntervals(long endAt = default(long), int whDel = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.WhDel = whDel;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RgmStatsResponseIntervals {\n");
        ...
        {
            return this.Equals(input as RgmStatsResponseIntervals);
        }

        /// <summary>
        /// Returns true if RgmStatsResponseIntervals instances are equal
        /// </summary>
        /// <param name="input">Instance of RgmStatsResponseIntervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RgmStatsResponseIntervals input)
        {
            if (input == null)
                return false;
