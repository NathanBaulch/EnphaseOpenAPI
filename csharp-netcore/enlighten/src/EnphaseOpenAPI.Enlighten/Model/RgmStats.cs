...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// RgmStats
    /// </summary>
    [DataContract(Name = "RgmStats")]
    public partial class RgmStats : IEquatable<RgmStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStats" /> class.
        /// </summary>
        ...
        public RgmStats(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<RgmStatsIntervals> intervals = default(List<RgmStatsIntervals>), List<RgmStatsMeterIntervals> meterIntervals = default(List<RgmStatsMeterIntervals>))
        {
            this.SystemId = systemId;
            this.TotalDevices = totalDevices;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for RgmStats and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for RgmStats and cannot be null");
            // to ensure "meterIntervals" is required (not null)
            this.MeterIntervals = meterIntervals ?? throw new ArgumentNullException("meterIntervals is a required property for RgmStats and cannot be null");
        }
        ...
        public List<RgmStatsIntervals> Intervals { get; set; }
        ...
        public List<RgmStatsMeterIntervals> MeterIntervals { get; set; }
        ...
        {
            return this.Equals(input as RgmStats);
        }

        /// <summary>
        /// Returns true if RgmStats instances are equal
        /// </summary>
        /// <param name="input">Instance of RgmStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RgmStats input)
        {
            if (input == null)
                return false;
