...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse20010 : IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<InlineResponse20010Intervals> intervals = default(List<InlineResponse20010Intervals>))
        {
            this.SystemId = systemId;
            this.TotalDevices = totalDevices;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse20010 and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for InlineResponse20010 and cannot be null");
        }
        ...
        public List<InlineResponse20010Intervals> Intervals { get; set; }
