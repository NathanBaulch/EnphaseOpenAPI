...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RgmStatsResponse_intervals_inner")]
    public partial class RgmStatsResponseIntervalsInner : IEquatable<RgmStatsResponseIntervalsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsResponseIntervalsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RgmStatsResponseIntervalsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsResponseIntervalsInner" /> class.
        /// </summary>
        ...
        /// <param name="devicesReporting">Number of revenue-grade meters that reported data for this interval at the time of the request. (required).</param>
        public RgmStatsResponseIntervalsInner(long endAt = default(long), int whDel = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.WhDel = whDel;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RgmStatsResponseIntervalsInner {\n");
        ...
        {
            return this.Equals(input as RgmStatsResponseIntervalsInner);
        }

        /// <summary>
        /// Returns true if RgmStatsResponseIntervalsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of RgmStatsResponseIntervalsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RgmStatsResponseIntervalsInner input)
        {
            if (input == null)
            {
                return false;
