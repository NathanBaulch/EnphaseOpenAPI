...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2009 : IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(DateTime startDate = default(DateTime), int systemId = default(int), List<int> consumption = default(List<int>), Meta meta = default(Meta))
        {
            this.StartDate = startDate;
            this.SystemId = systemId;
            // to ensure "consumption" is required (not null)
            this.Consumption = consumption ?? throw new ArgumentNullException("consumption is a required property for InlineResponse2009 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2009 and cannot be null");
        }
