...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// RgmStatsIntervals1
    /// </summary>
    [DataContract(Name = "RgmStats_intervals_1")]
    public partial class RgmStatsIntervals1 : IEquatable<RgmStatsIntervals1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsIntervals1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RgmStatsIntervals1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsIntervals1" /> class.
        /// </summary>
        ...
        public RgmStatsIntervals1(int channel = default(int), long endAt = default(long), float whDel = default(float), int currW = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RgmStatsIntervals1 {\n");
        ...
        {
            return this.Equals(input as RgmStatsIntervals1);
        }

        /// <summary>
        /// Returns true if RgmStatsIntervals1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RgmStatsIntervals1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RgmStatsIntervals1 input)
        {
            if (input == null)
                return false;
