...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// ConsumptionLifetime
    /// </summary>
    [DataContract(Name = "ConsumptionLifetime")]
    public partial class ConsumptionLifetime : IEquatable<ConsumptionLifetime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionLifetime" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsumptionLifetime() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionLifetime" /> class.
        /// </summary>
        ...
        public ConsumptionLifetime(DateTime startDate = default(DateTime), int systemId = default(int), List<int> consumption = default(List<int>), Meta meta = default(Meta))
        {
            this.StartDate = startDate;
            this.SystemId = systemId;
            // to ensure "consumption" is required (not null)
            this.Consumption = consumption ?? throw new ArgumentNullException("consumption is a required property for ConsumptionLifetime and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for ConsumptionLifetime and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumptionLifetime {\n");
        ...
        {
            return this.Equals(input as ConsumptionLifetime);
        }

        /// <summary>
        /// Returns true if ConsumptionLifetime instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsumptionLifetime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumptionLifetime input)
        {
            if (input == null)
                return false;
