...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_6_meter_readings")]
    public partial class InlineResponse2006MeterReadings : IEquatable<InlineResponse2006MeterReadings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006MeterReadings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2006MeterReadings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006MeterReadings" /> class.
        /// </summary>
        ...
        public InlineResponse2006MeterReadings(string serialNumber = default(string), int value = default(int), int readAt = default(int))
        {
            // to ensure "serialNumber" is required (not null)
            this.SerialNumber = serialNumber ?? throw new ArgumentNullException("serialNumber is a required property for InlineResponse2006MeterReadings and cannot be null");
            this.Value = value;
            this.ReadAt = readAt;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2006MeterReadings {\n");
        ...
        {
            return this.Equals(input as InlineResponse2006MeterReadings);
        }

        /// <summary>
        /// Returns true if InlineResponse2006MeterReadings instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006MeterReadings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006MeterReadings input)
        {
            if (input == null)
                return false;
