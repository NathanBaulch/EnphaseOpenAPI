...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnvoysResponse_envoys")]
    public partial class EnvoysResponseEnvoys : IEquatable<EnvoysResponseEnvoys>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvoysResponseEnvoys" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnvoysResponseEnvoys() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvoysResponseEnvoys" /> class.
        /// </summary>
        ...
        public EnvoysResponseEnvoys(int envoyId = default(int), long lastReportAt = default(long), string name = default(string), string partNumber = default(string), string serialNumber = default(string), StatusEnum status = default(StatusEnum))
        {
        ...
        {
            return this.Equals(input as EnvoysResponseEnvoys);
        }

        /// <summary>
        /// Returns true if EnvoysResponseEnvoys instances are equal
        /// </summary>
        /// <param name="input">Instance of EnvoysResponseEnvoys to be compared</param>
        /// <returns>Boolean</returns>
