...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2005 : IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(int systemId = default(int), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), int productionWh = default(int), List<InlineResponse2005MeterReadings> meterReadings = default(List<InlineResponse2005MeterReadings>), Meta meta = default(Meta))
        {
            ...
            this.MeterReadings = meterReadings ?? throw new ArgumentNullException("meterReadings is a required property for InlineResponse2005 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2005 and cannot be null");
        }
        ...
        public List<InlineResponse2005MeterReadings> MeterReadings { get; set; }
