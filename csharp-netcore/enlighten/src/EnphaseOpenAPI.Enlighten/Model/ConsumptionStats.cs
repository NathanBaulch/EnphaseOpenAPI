...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// ConsumptionStats
    /// </summary>
    [DataContract(Name = "ConsumptionStats")]
    public partial class ConsumptionStats : IEquatable<ConsumptionStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionStats" /> class.
        /// </summary>
        ...
        public ConsumptionStats(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<ConsumptionStatsIntervals> intervals = default(List<ConsumptionStatsIntervals>))
        {
            this.SystemId = systemId;
            this.TotalDevices = totalDevices;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for ConsumptionStats and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for ConsumptionStats and cannot be null");
        }
        ...
        public List<ConsumptionStatsIntervals> Intervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumptionStats {\n");
        ...
        {
            return this.Equals(input as ConsumptionStats);
        }

        /// <summary>
        /// Returns true if ConsumptionStats instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsumptionStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumptionStats input)
        {
            if (input == null)
                return false;
