...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// MonthlyProduction
    /// </summary>
    [DataContract(Name = "MonthlyProduction")]
    public partial class MonthlyProduction : IEquatable<MonthlyProduction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonthlyProduction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MonthlyProduction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MonthlyProduction" /> class.
        /// </summary>
        ...
        public MonthlyProduction(int systemId = default(int), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), int productionWh = default(int), List<MonthlyProductionMeterReadings> meterReadings = default(List<MonthlyProductionMeterReadings>), Meta meta = default(Meta))
        {
            ...
            this.MeterReadings = meterReadings ?? throw new ArgumentNullException("meterReadings is a required property for MonthlyProduction and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for MonthlyProduction and cannot be null");
        }
        ...
        public List<MonthlyProductionMeterReadings> MeterReadings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MonthlyProduction {\n");
        ...
        {
            return this.Equals(input as MonthlyProduction);
        }

        /// <summary>
        /// Returns true if MonthlyProduction instances are equal
        /// </summary>
        /// <param name="input">Instance of MonthlyProduction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MonthlyProduction input)
        {
            if (input == null)
                return false;
