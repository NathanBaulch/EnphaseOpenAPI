...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class Stats : IEquatable<Stats>, IValidatableObject
    {
        ...
        public Stats(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<StatsIntervals> intervals = default(List<StatsIntervals>))
        {
            this.SystemId = systemId;
            this.TotalDevices = totalDevices;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for Stats and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for Stats and cannot be null");
        }
        ...
        public List<StatsIntervals> Intervals { get; set; }
