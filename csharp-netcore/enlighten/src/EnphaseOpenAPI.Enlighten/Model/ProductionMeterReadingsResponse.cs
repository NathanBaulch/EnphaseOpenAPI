...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductionMeterReadingsResponse")]
    public partial class ProductionMeterReadingsResponse : IEquatable<ProductionMeterReadingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductionMeterReadingsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductionMeterReadingsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductionMeterReadingsResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProductionMeterReadingsResponse);
        }

        /// <summary>
        /// Returns true if ProductionMeterReadingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductionMeterReadingsResponse to be compared</param>
        /// <returns>Boolean</returns>
