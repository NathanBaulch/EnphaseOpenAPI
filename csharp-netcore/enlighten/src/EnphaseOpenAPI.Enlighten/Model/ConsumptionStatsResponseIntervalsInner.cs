...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsumptionStatsResponse_intervals_inner")]
    public partial class ConsumptionStatsResponseIntervalsInner : IEquatable<ConsumptionStatsResponseIntervalsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionStatsResponseIntervalsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsumptionStatsResponseIntervalsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumptionStatsResponseIntervalsInner" /> class.
        /// </summary>
        ...
        public ConsumptionStatsResponseIntervalsInner(long endAt = default(long), int enwh = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.Enwh = enwh;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumptionStatsResponseIntervalsInner {\n");
        ...
        {
            return this.Equals(input as ConsumptionStatsResponseIntervalsInner);
        }

        /// <summary>
        /// Returns true if ConsumptionStatsResponseIntervalsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsumptionStatsResponseIntervalsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumptionStatsResponseIntervalsInner input)
        {
            if (input == null)
            {
                return false;
