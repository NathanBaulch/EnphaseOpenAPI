...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2003 : IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(int systemId = default(int), List<InlineResponse2003Envoys> envoys = default(List<InlineResponse2003Envoys>), List<InlineResponse2003Envoys> inverters = default(List<InlineResponse2003Envoys>), List<InlineResponse2003Meters> meters = default(List<InlineResponse2003Meters>), Meta meta = default(Meta))
        {
            this.SystemId = systemId;
            // to ensure "inverters" is required (not null)
            this.Inverters = inverters ?? throw new ArgumentNullException("inverters is a required property for InlineResponse2003 and cannot be null");
            // to ensure "meters" is required (not null)
            this.Meters = meters ?? throw new ArgumentNullException("meters is a required property for InlineResponse2003 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2003 and cannot be null");
            this.Envoys = envoys;
        }
        ...
        public List<InlineResponse2003Envoys> Envoys { get; set; }
        ...
        public List<InlineResponse2003Envoys> Inverters { get; set; }
        ...
        public List<InlineResponse2003Meters> Meters { get; set; }
