...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class ConflictError : IEquatable<ConflictError>, IValidatableObject
    {
        /// <summary>
        /// Defines Period
        /// </summary>
        ...
        {
            return this.Equals(input as ConflictError);
        }

        /// <summary>
        /// Returns true if ConflictError instances are equal
        /// </summary>
        /// <param name="input">Instance of ConflictError to be compared</param>
        /// <returns>Boolean</returns>
