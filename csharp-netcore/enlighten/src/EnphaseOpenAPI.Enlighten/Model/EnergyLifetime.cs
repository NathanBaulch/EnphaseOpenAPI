...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// EnergyLifetime
    /// </summary>
    [DataContract(Name = "EnergyLifetime")]
    public partial class EnergyLifetime : IEquatable<EnergyLifetime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyLifetime" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnergyLifetime() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyLifetime" /> class.
        /// </summary>
        ...
        public EnergyLifetime(DateTime startDate = default(DateTime), int systemId = default(int), List<int> production = default(List<int>), List<int> microProduction = default(List<int>), List<int> meterProduction = default(List<int>), DateTime meterStartDate = default(DateTime), Meta meta = default(Meta))
        {
            this.StartDate = startDate;
            this.SystemId = systemId;
            // to ensure "production" is required (not null)
            this.Production = production ?? throw new ArgumentNullException("production is a required property for EnergyLifetime and cannot be null");
            // to ensure "microProduction" is required (not null)
            this.MicroProduction = microProduction ?? throw new ArgumentNullException("microProduction is a required property for EnergyLifetime and cannot be null");
            // to ensure "meterProduction" is required (not null)
            this.MeterProduction = meterProduction ?? throw new ArgumentNullException("meterProduction is a required property for EnergyLifetime and cannot be null");
            this.MeterStartDate = meterStartDate;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for EnergyLifetime and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnergyLifetime {\n");
        ...
        {
            return this.Equals(input as EnergyLifetime);
        }

        /// <summary>
        /// Returns true if EnergyLifetime instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyLifetime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyLifetime input)
        {
            if (input == null)
                return false;
