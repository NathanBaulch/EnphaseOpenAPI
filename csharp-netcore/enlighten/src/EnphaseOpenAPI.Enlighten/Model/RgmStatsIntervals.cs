...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// RgmStatsIntervals
    /// </summary>
    [DataContract(Name = "RgmStats_intervals")]
    public partial class RgmStatsIntervals : IEquatable<RgmStatsIntervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsIntervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RgmStatsIntervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RgmStatsIntervals" /> class.
        /// </summary>
        ...
        public RgmStatsIntervals(long endAt = default(long), int whDel = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.WhDel = whDel;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RgmStatsIntervals {\n");
        ...
        {
            return this.Equals(input as RgmStatsIntervals);
        }

        /// <summary>
        /// Returns true if RgmStatsIntervals instances are equal
        /// </summary>
        /// <param name="input">Instance of RgmStatsIntervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RgmStatsIntervals input)
        {
            if (input == null)
                return false;
