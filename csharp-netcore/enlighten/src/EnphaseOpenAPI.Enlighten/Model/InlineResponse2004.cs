...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class InlineResponse2004 : IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(int signalStrength = default(int), List<InlineResponse2004MicroInverters> microInverters = default(List<InlineResponse2004MicroInverters>))
        {
            this.SignalStrength = signalStrength;
            // to ensure "microInverters" is required (not null)
            this.MicroInverters = microInverters ?? throw new ArgumentNullException("microInverters is a required property for InlineResponse2004 and cannot be null");
        }
        ...
        public List<InlineResponse2004MicroInverters> MicroInverters { get; set; }
