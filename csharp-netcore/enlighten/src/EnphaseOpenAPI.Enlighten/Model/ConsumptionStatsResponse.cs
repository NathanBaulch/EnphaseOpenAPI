...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    public partial class ConsumptionStatsResponse : IEquatable<ConsumptionStatsResponse>, IValidatableObject
    {
        ...
        public ConsumptionStatsResponse(int systemId = default(int), int totalDevices = default(int), Meta meta = default(Meta), List<ConsumptionStatsResponseIntervals> intervals = default(List<ConsumptionStatsResponseIntervals>))
        {
            ...
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for ConsumptionStatsResponse and cannot be null");
            // to ensure "intervals" is required (not null)
            this.Intervals = intervals ?? throw new ArgumentNullException("intervals is a required property for ConsumptionStatsResponse and cannot be null");
        }
