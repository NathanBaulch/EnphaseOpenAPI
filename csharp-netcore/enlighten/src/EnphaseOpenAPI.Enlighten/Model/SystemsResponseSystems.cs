...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemsResponse_systems")]
    public partial class SystemsResponseSystems : IEquatable<SystemsResponseSystems>, IValidatableObject
    {
        ...
        protected SystemsResponseSystems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemsResponseSystems" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SystemsResponseSystems);
        }

        /// <summary>
        /// Returns true if SystemsResponseSystems instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemsResponseSystems to be compared</param>
        /// <returns>Boolean</returns>
