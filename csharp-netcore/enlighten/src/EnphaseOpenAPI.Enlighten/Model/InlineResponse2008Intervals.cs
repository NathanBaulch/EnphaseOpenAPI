...
namespace EnphaseOpenAPI.Enlighten.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_8_intervals")]
    public partial class InlineResponse2008Intervals : IEquatable<InlineResponse2008Intervals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008Intervals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2008Intervals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008Intervals" /> class.
        /// </summary>
        ...
        public InlineResponse2008Intervals(int endAt = default(int), int powr = default(int), int enwh = default(int), int devicesReporting = default(int))
        {
            this.EndAt = endAt;
            this.Powr = powr;
            this.Enwh = enwh;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2008Intervals {\n");
        ...
        {
            return this.Equals(input as InlineResponse2008Intervals);
        }

        /// <summary>
        /// Returns true if InlineResponse2008Intervals instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008Intervals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008Intervals input)
        {
            if (input == null)
                return false;
