...
namespace EnphaseOpenAPI.Enlighten.Api
{
    ...
    public interface IDefaultApiSync : IApiAccessor
    {
        ...
        /// <param name="userId"></param>
        /// <param name="systemId"></param>
        /// <param name="startDate">Start date for reporting period. The reporting period ends on the previous day of the next month; for example, a &#x60;start_date&#x60; of 2011-07-20 returns data through 2011-06-19. When the start date is the first of a calendar month, the end date is the last day of that month.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
