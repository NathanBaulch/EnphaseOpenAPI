...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemHost" /> class.
        /// </summary>
        ...
        public SystemHost(string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), bool active = default(bool), int userId = default(int), List<UserRoleEnum> userRoles = default(List<UserRoleEnum>), bool enlightenEmails = default(bool), string enlightenView = default(string), string uri = default(string), long updatedAt = default(long), SystemHostCompany company = default(SystemHostCompany))
        {
        ...
        public SystemHostCompany Company { get; set; }
        ...
        {
            return this.Equals(input as SystemHost);
        }

        /// <summary>
        /// Returns true if SystemHost instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemHost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemHost input)
        {
            if (input == null)
            {
                return false;
