...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Activation_encharge_inner")]
    public partial class ActivationEnchargeInner : IEquatable<ActivationEnchargeInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivationEnchargeInner" /> class.
        /// </summary>
        /// <param name="envoySerialNumber">Envoy serial number..</param>
        /// <param name="enchargeSerialNumbers">Encharge serial numbers..</param>
        public ActivationEnchargeInner(string envoySerialNumber = default(string), List<string> enchargeSerialNumbers = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivationEnchargeInner {\n");
        ...
        {
            return this.Equals(input as ActivationEnchargeInner);
        }

        /// <summary>
        /// Returns true if ActivationEnchargeInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivationEnchargeInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivationEnchargeInner input)
        {
            if (input == null)
            {
                return false;
