...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// ArraysLayersInner
    /// </summary>
    [DataContract(Name = "Arrays_layers_inner")]
    public partial class ArraysLayersInner : IEquatable<ArraysLayersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArraysLayersInner" /> class.
        /// </summary>
        ...
        public ArraysLayersInner(string file = default(string), int scale = default(int), int angle = default(int), int opacity = default(int), int width = default(int), int height = default(int), int left = default(int), int top = default(int))
        {
            this.File = file;
            this.Scale = scale;
            this.Angle = angle;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArraysLayersInner {\n");
        ...
        {
            return this.Equals(input as ArraysLayersInner);
        }

        /// <summary>
        /// Returns true if ArraysLayersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ArraysLayersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArraysLayersInner input)
        {
            if (input == null)
            {
                return false;
