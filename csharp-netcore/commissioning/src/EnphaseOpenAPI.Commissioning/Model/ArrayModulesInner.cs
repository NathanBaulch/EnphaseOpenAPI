...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// ArrayModulesInner
    /// </summary>
    [DataContract(Name = "Array_modules_inner")]
    public partial class ArrayModulesInner : IEquatable<ArrayModulesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayModulesInner" /> class.
        /// </summary>
        ...
        public ArrayModulesInner(int id = default(int), int left = default(int), int top = default(int), int angle = default(int), string serialNum = default(string))
        {
            this.Id = id;
            this.Left = left;
            this.Top = top;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArrayModulesInner {\n");
        ...
        {
            return this.Equals(input as ArrayModulesInner);
        }

        /// <summary>
        /// Returns true if ArrayModulesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrayModulesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrayModulesInner input)
        {
            if (input == null)
            {
                return false;
