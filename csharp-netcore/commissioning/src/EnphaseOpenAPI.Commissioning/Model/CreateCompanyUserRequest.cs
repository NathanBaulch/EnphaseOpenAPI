...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    public partial class CreateCompanyUserRequest : IEquatable<CreateCompanyUserRequest>, IValidatableObject
    {
        ...
        public CreateCompanyUserRequest(string email = default(string), bool enlightenEmails = default(bool), string firstName = default(string), string lastName = default(string), string phone = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for CreateCompanyUserRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for CreateCompanyUserRequest and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for CreateCompanyUserRequest and cannot be null");
            }
