...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemParams_encharge_inner")]
    public partial class SystemParamsEnchargeInner : IEquatable<SystemParamsEnchargeInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemParamsEnchargeInner" /> class.
        /// </summary>
        /// <param name="envoySerialNumber">Envoy serial number..</param>
        /// <param name="enchargeSerialNumbers">Encharge serial numbers..</param>
        public SystemParamsEnchargeInner(string envoySerialNumber = default(string), List<string> enchargeSerialNumbers = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemParamsEnchargeInner {\n");
        ...
        {
            return this.Equals(input as SystemParamsEnchargeInner);
        }

        /// <summary>
        /// Returns true if SystemParamsEnchargeInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemParamsEnchargeInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemParamsEnchargeInner input)
        {
            if (input == null)
            {
                return false;
