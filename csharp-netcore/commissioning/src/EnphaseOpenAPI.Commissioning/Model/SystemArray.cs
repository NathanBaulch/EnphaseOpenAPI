...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// SystemArray
    /// </summary>
    [DataContract(Name = "SystemArray")]
    public partial class SystemArray : IEquatable<SystemArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemArray" /> class.
        /// </summary>
        ...
        public List<SystemArrayModulesInner> Modules { get; set; }
        ...
        {
            return this.Equals(input as SystemArray);
        }

        /// <summary>
        /// Returns true if SystemArray instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemArray input)
        {
            if (input == null)
            {
                return false;
