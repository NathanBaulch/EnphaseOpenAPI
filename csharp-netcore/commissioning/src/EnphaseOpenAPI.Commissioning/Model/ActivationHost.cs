...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Activation_host")]
    public partial class ActivationHost : IEquatable<ActivationHost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivationHost" /> class.
        /// </summary>
        ...
        public ActivationHost(string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), bool active = default(bool), int userId = default(int), List<UserRoleEnum> userRoles = default(List<UserRoleEnum>), bool enlightenEmails = default(bool), string enlightenView = default(string), string uri = default(string), long updatedAt = default(long), ActivationHostCompany company = default(ActivationHostCompany))
        {
        ...
        public ActivationHostCompany Company { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivationHost {\n");
        ...
        {
            return this.Equals(input as ActivationHost);
        }

        /// <summary>
        /// Returns true if ActivationHost instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivationHost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivationHost input)
        {
            if (input == null)
            {
                return false;
