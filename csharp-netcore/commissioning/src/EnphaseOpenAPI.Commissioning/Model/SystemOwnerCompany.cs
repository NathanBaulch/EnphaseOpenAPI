...
namespace EnphaseOpenAPI.Commissioning.Model
{
    ...
    /// </summary>
    [DataContract(Name = "System_owner_company")]
    public partial class SystemOwnerCompany : IEquatable<SystemOwnerCompany>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemOwnerCompany" /> class.
        /// </summary>
        ...
        public SystemOwnerCompany(int companyId = default(int), string companyName = default(string), string location = default(string), List<CompanyRoleEnum> roles = default(List<CompanyRoleEnum>), string uri = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemOwnerCompany {\n");
        ...
        {
            return this.Equals(input as SystemOwnerCompany);
        }

        /// <summary>
        /// Returns true if SystemOwnerCompany instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemOwnerCompany to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemOwnerCompany input)
        {
            if (input == null)
            {
                return false;
