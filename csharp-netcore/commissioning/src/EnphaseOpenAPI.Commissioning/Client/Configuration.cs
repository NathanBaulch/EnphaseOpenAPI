...
namespace EnphaseOpenAPI.Commissioning.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("EnphaseOpenAPI/csharp-netcore");
            BasePath = "https://api.enphaseenergy.com/api/v4";
        ...
        public Configuration(
            ...
            string basePath = "https://api.enphaseenergy.com/api/v4") : this()
        {
        ...
        {
            string report = "C# SDK (EnphaseOpenAPI.Commissioning) Debug Report:\n";
