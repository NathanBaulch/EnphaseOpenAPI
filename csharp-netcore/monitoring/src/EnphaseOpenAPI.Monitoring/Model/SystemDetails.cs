...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// SystemDetails
    /// </summary>
    [DataContract(Name = "SystemDetails")]
    public partial class SystemDetails : IEquatable<SystemDetails>, IValidatableObject
    {
        ...
        public SystemDetails(int systemId = default(int), string name = default(string), string publicName = default(string), string timezone = default(string), SystemDetailsAddress address = default(SystemDetailsAddress), SystemConnectionTypeEnum? connectionType = default(SystemConnectionTypeEnum?), int energyLifetime = default(int), int energyToday = default(int), int systemSize = default(int), SystemStatusEnum? status = default(SystemStatusEnum?), long lastReportAt = default(long), long lastEnergyAt = default(long), long operationalAt = default(long), SystemAttachmentTypeEnum? attachmentType = default(SystemAttachmentTypeEnum?), DateTimeOffset interconnectDate = default(DateTimeOffset), string reference = default(string), List<string> otherReferences = default(List<string>))
        {
        ...
        public SystemDetailsAddress Address { get; set; }
        ...
        {
            return this.Equals(input as SystemDetails);
        }

        /// <summary>
        /// Returns true if SystemDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemDetails input)
        {
            if (input == null)
            {
                return false;
