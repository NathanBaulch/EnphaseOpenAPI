...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// StormGuardSettings
    /// </summary>
    [DataContract(Name = "StormGuardSettings")]
    public partial class StormGuardSettings : IEquatable<StormGuardSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StormGuardSettings" /> class.
        /// </summary>
        ...
        public StormGuardSettings(int systemId = default(int), string stormGuardStatus = default(string), bool stormAlert = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StormGuardSettings {\n");
        ...
        {
            return this.Equals(input as StormGuardSettings);
        }

        /// <summary>
        /// Returns true if StormGuardSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of StormGuardSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StormGuardSettings input)
        {
            if (input == null)
            {
                return false;
