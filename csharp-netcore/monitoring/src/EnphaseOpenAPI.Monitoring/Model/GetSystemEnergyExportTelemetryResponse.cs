...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSystemEnergyExportTelemetryResponse")]
    public partial class GetSystemEnergyExportTelemetryResponse : IEquatable<GetSystemEnergyExportTelemetryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemEnergyExportTelemetryResponse" /> class.
        /// </summary>
        ...
        public GetSystemEnergyExportTelemetryResponse(int systemId = default(int), string granularity = default(string), int totalDevices = default(int), long startAt = default(long), long endAt = default(long), string items = default(string), List<List<GetSystemEnergyExportTelemetryResponseIntervalsInnerInner>> intervals = default(List<List<GetSystemEnergyExportTelemetryResponseIntervalsInnerInner>>), Meta meta = default(Meta))
        {
        ...
        public List<List<GetSystemEnergyExportTelemetryResponseIntervalsInnerInner>> Intervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSystemEnergyExportTelemetryResponse {\n");
        ...
        {
            return this.Equals(input as GetSystemEnergyExportTelemetryResponse);
        }

        /// <summary>
        /// Returns true if GetSystemEnergyExportTelemetryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSystemEnergyExportTelemetryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSystemEnergyExportTelemetryResponse input)
        {
            if (input == null)
            {
                return false;
