...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveData_463_response")]
    public partial class StreamSystemLiveData463Response : IEquatable<StreamSystemLiveData463Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveData463Response" /> class.
        /// </summary>
        ...
        public StreamSystemLiveData463Response(StreamSystemLiveData463ResponseError error = default(StreamSystemLiveData463ResponseError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveData463ResponseError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveData463Response {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveData463Response);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveData463Response instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveData463Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveData463Response input)
        {
            if (input == null)
            {
                return false;
