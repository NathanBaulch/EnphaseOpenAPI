...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveData_466_response")]
    public partial class StreamSystemLiveData466Response : IEquatable<StreamSystemLiveData466Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveData466Response" /> class.
        /// </summary>
        ...
        public StreamSystemLiveData466Response(StreamSystemLiveData466ResponseError error = default(StreamSystemLiveData466ResponseError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveData466ResponseError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveData466Response {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveData466Response);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveData466Response instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveData466Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveData466Response input)
        {
            if (input == null)
            {
                return false;
