...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSystemBatteryTelemetryResponse")]
    public partial class GetSystemBatteryTelemetryResponse : IEquatable<GetSystemBatteryTelemetryResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemBatteryTelemetryResponse" /> class.
        /// </summary>
        /// <param name="systemId">Unique numeric ID of the system..</param>
        /// <param name="granularity">granularity.</param>
        /// <param name="totalDevices">Number of batteries in the site..</param>
        ...
        /// <param name="lastReportedAggregateSoc">Last reported aggregate soc percentage..</param>
        public GetSystemBatteryTelemetryResponse(int systemId = default(int), TelemetryGranularityEnum? granularity = default(TelemetryGranularityEnum?), int totalDevices = default(int), long startAt = default(long), long endAt = default(long), string items = default(string), List<GetSystemBatteryTelemetryResponseIntervalsInner> intervals = default(List<GetSystemBatteryTelemetryResponseIntervalsInner>), string lastReportedAggregateSoc = default(string))
        {
            ...
            this.LastReportedAggregateSoc = lastReportedAggregateSoc;
        }
        ...
        /// </summary>
        /// <value>Number of batteries in the site.</value>
        ...
        public List<GetSystemBatteryTelemetryResponseIntervalsInner> Intervals { get; set; }

        /// <summary>
        /// Last reported aggregate soc percentage.
        /// </summary>
        /// <value>Last reported aggregate soc percentage.</value>
        [DataMember(Name = "last_reported_aggregate_soc", EmitDefaultValue = false)]
        public string LastReportedAggregateSoc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSystemBatteryTelemetryResponse {\n");
            ...
            sb.Append("  LastReportedAggregateSoc: ").Append(LastReportedAggregateSoc).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as GetSystemBatteryTelemetryResponse);
        }

        /// <summary>
        /// Returns true if GetSystemBatteryTelemetryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSystemBatteryTelemetryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSystemBatteryTelemetryResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LastReportedAggregateSoc == input.LastReportedAggregateSoc ||
                    (this.LastReportedAggregateSoc != null &&
                    this.LastReportedAggregateSoc.Equals(input.LastReportedAggregateSoc))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastReportedAggregateSoc != null)
                {
                    hashCode = (hashCode * 59) + this.LastReportedAggregateSoc.GetHashCode();
                }
                return hashCode;
            }
        }
