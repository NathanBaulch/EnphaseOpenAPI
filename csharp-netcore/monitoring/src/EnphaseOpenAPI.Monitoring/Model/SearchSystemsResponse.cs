...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    public partial class SearchSystemsResponse : IEquatable<SearchSystemsResponse>, IValidatableObject
    {
        ...
        public SearchSystemsResponse(int total = default(int), int currentPage = default(int), int size = default(int), int count = default(int), string items = default(string), List<SystemDetails> systems = default(List<SystemDetails>))
        {
            this.Total = total;
