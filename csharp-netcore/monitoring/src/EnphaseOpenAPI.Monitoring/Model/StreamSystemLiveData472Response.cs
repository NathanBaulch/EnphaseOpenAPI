...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveData_472_response")]
    public partial class StreamSystemLiveData472Response : IEquatable<StreamSystemLiveData472Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveData472Response" /> class.
        /// </summary>
        ...
        public StreamSystemLiveData472Response(StreamSystemLiveData472ResponseError error = default(StreamSystemLiveData472ResponseError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveData472ResponseError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveData472Response {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveData472Response);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveData472Response instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveData472Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveData472Response input)
        {
            if (input == null)
            {
                return false;
