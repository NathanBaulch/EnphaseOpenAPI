...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveDataError")]
    public partial class StreamSystemLiveDataError : IEquatable<StreamSystemLiveDataError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveDataError" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="timestampEpoch">Timestamp in epoch format..</param>
        /// <param name="timestampUtc">Timestamp in UTC format..</param>
        /// <param name="type">type.</param>
        public StreamSystemLiveDataError(StreamSystemLiveDataErrorError error = default(StreamSystemLiveDataErrorError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveDataErrorError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveDataError {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveDataError);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveDataError instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveDataError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveDataError input)
        {
            if (input == null)
            {
                return false;
