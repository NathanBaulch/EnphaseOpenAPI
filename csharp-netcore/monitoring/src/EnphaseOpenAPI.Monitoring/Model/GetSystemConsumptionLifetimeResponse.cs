...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSystemConsumptionLifetimeResponse")]
    public partial class GetSystemConsumptionLifetimeResponse : IEquatable<GetSystemConsumptionLifetimeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemConsumptionLifetimeResponse" /> class.
        /// </summary>
        ...
        /// <param name="consumption">An array of consumption measurements in Wh, one for each day since consumption metering began, or one for each day of the requested period..</param>
        /// <param name="meta">meta.</param>
        public GetSystemConsumptionLifetimeResponse(int systemId = default(int), DateTimeOffset startDate = default(DateTimeOffset), List<int> consumption = default(List<int>), Meta meta = default(Meta))
        {
        ...
        /// </summary>
        /// <value>An array of consumption measurements in Wh, one for each day since consumption metering began, or one for each day of the requested period.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSystemConsumptionLifetimeResponse {\n");
        ...
        {
            return this.Equals(input as GetSystemConsumptionLifetimeResponse);
        }

        /// <summary>
        /// Returns true if GetSystemConsumptionLifetimeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSystemConsumptionLifetimeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSystemConsumptionLifetimeResponse input)
        {
            if (input == null)
            {
                return false;
