...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "System_address")]
    public partial class SystemAddress : IEquatable<SystemAddress>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SystemAddress);
        }

        /// <summary>
        /// Returns true if SystemAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemAddress input)
        {
            if (input == null)
            {
                return false;
