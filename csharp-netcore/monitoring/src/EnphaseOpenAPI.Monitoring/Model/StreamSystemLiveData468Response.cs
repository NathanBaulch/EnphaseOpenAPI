...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveData_468_response")]
    public partial class StreamSystemLiveData468Response : IEquatable<StreamSystemLiveData468Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveData468Response" /> class.
        /// </summary>
        ...
        public StreamSystemLiveData468Response(StreamSystemLiveData468ResponseError error = default(StreamSystemLiveData468ResponseError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveData468ResponseError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveData468Response {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveData468Response);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveData468Response instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveData468Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveData468Response input)
        {
            if (input == null)
            {
                return false;
