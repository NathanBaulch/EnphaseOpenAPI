...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSystemEnergyImportTelemetryResponse")]
    public partial class GetSystemEnergyImportTelemetryResponse : IEquatable<GetSystemEnergyImportTelemetryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemEnergyImportTelemetryResponse" /> class.
        /// </summary>
        /// <param name="systemId">Unique numeric ID of the system..</param>
        /// <param name="granularity">Granularity of the telemetry data. Default is &#39;day&#39;..</param>
        /// <param name="totalDevices">Number of consumption meters in the site..</param>
        ...
        /// <param name="intervals">An array of telemetry objects..</param>
        /// <param name="meta">meta.</param>
        public GetSystemEnergyImportTelemetryResponse(int systemId = default(int), string granularity = default(string), int totalDevices = default(int), long startAt = default(long), long endAt = default(long), string items = default(string), List<List<GetSystemEnergyImportTelemetryResponseIntervalsInnerInner>> intervals = default(List<List<GetSystemEnergyImportTelemetryResponseIntervalsInnerInner>>), Meta meta = default(Meta))
        {
        ...
        /// </summary>
        /// <value>Number of consumption meters in the site.</value>
        ...
        /// </summary>
        /// <value>An array of telemetry objects.</value>
        [DataMember(Name = "intervals", EmitDefaultValue = false)]
        public List<List<GetSystemEnergyImportTelemetryResponseIntervalsInnerInner>> Intervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSystemEnergyImportTelemetryResponse {\n");
        ...
        {
            return this.Equals(input as GetSystemEnergyImportTelemetryResponse);
        }

        /// <summary>
        /// Returns true if GetSystemEnergyImportTelemetryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSystemEnergyImportTelemetryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSystemEnergyImportTelemetryResponse input)
        {
            if (input == null)
            {
                return false;
