...
namespace EnphaseOpenAPI.Monitoring.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreamSystemLiveData_462_response")]
    public partial class StreamSystemLiveData462Response : IEquatable<StreamSystemLiveData462Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamSystemLiveData462Response" /> class.
        /// </summary>
        ...
        public StreamSystemLiveData462Response(StreamSystemLiveData462ResponseError error = default(StreamSystemLiveData462ResponseError), int timestampEpoch = default(int), string timestampUtc = default(string), string type = default(string))
        {
            this.Error = error;
        ...
        public StreamSystemLiveData462ResponseError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreamSystemLiveData462Response {\n");
        ...
        {
            return this.Equals(input as StreamSystemLiveData462Response);
        }

        /// <summary>
        /// Returns true if StreamSystemLiveData462Response instances are equal
        /// </summary>
        /// <param name="input">Instance of StreamSystemLiveData462Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreamSystemLiveData462Response input)
        {
            if (input == null)
            {
                return false;
