...
class InlineResponse20011 {
     ...
     * @param source {module:model/InlineResponse20011.SourceEnum} Indicates whether the production of this system is measured by its microinverters (`microinverters`) or by revenue-grade meters (`meter`) installed on the system.
    ...
    constructor(currentPower, energyLifetime, energyToday, lastIntervalEndAt, lastReportAt, modules, operationalAt, sizeW, source, status, summaryDate, systemId) { 
        ...
        InlineResponse20011.initialize(this, currentPower, energyLifetime, energyToday, lastIntervalEndAt, lastReportAt, modules, operationalAt, sizeW, source, status, summaryDate, systemId);
    }
 ...
 */
InlineResponse20011.prototype['last_interval_end_at'] = undefined;
 ...
 */
InlineResponse20011.prototype['last_report_at'] = undefined;

/**
 * Number of active (not retired) modules. For historical requests, returns 0.
 * @member {Number} modules
 */
InlineResponse20011.prototype['modules'] = undefined;
 ...
 */
InlineResponse20011.prototype['operational_at'] = undefined;

/**
 * The size of the system, in Watts. For historical requests, returns 0.
 * @member {Number} size_w
 */
InlineResponse20011.prototype['size_w'] = undefined;
 ...
 * @member {module:model/InlineResponse20011.SourceEnum} source
 */
InlineResponse20011.prototype['source'] = undefined;
 ...
 */
InlineResponse20011.prototype['summary_date'] = undefined;

/**
 * The Enlighten ID of the system.
 * @member {Number} system_id
 */
InlineResponse20011.prototype['system_id'] = undefined;
 ...
 * @readonly
 */
InlineResponse20011['SourceEnum'] = {
