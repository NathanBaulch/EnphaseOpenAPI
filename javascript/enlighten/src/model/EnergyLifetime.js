...
/**
 * The EnergyLifetime model module.
 * @module model/EnergyLifetime
 * @version 2.0
 */
class EnergyLifetime {
    /**
     * Constructs a new <code>EnergyLifetime</code>.
     * @alias module:model/EnergyLifetime
     ...
     * @param microProduction {Array.<Number>} 
     * @param meterProduction {Array.<Number>} 
     * @param meterStartDate {Date} The first day in the time series when measurements are taken from a meter instead of from microinverters. This field is not present unless the system has a meter.
     * @param meta {module:model/Meta} 
     */
    constructor(startDate, systemId, production, microProduction, meterProduction, meterStartDate, meta) { 
        
        EnergyLifetime.initialize(this, startDate, systemId, production, microProduction, meterProduction, meterStartDate, meta);
    }
     ...
     */
    static initialize(obj, startDate, systemId, production, microProduction, meterProduction, meterStartDate, meta) { 
        obj['start_date'] = startDate;
        obj['system_id'] = systemId;
        obj['production'] = production;
        obj['micro_production'] = microProduction;
        obj['meter_production'] = meterProduction;
        obj['meter_start_date'] = meterStartDate;
        obj['meta'] = meta;
    }

    /**
     * Constructs a <code>EnergyLifetime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnergyLifetime} obj Optional instance to populate.
     * @return {module:model/EnergyLifetime} The populated <code>EnergyLifetime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnergyLifetime();
 ...
 */
EnergyLifetime.prototype['start_date'] = undefined;

/**
 * The identifier of the system.
 * @member {Number} system_id
 */
EnergyLifetime.prototype['system_id'] = undefined;
 ...
 */
EnergyLifetime.prototype['production'] = undefined;

/**
 * @member {Array.<Number>} micro_production
 */
EnergyLifetime.prototype['micro_production'] = undefined;

/**
 * @member {Array.<Number>} meter_production
 */
EnergyLifetime.prototype['meter_production'] = undefined;
 ...
 */
EnergyLifetime.prototype['meter_start_date'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
EnergyLifetime.prototype['meta'] = undefined;
