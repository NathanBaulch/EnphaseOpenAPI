...
import InlineResponse2004Energy from './InlineResponse2004Energy';

/**
 * The InlineResponse2004MicroInverters model module.
 * @module model/InlineResponse2004MicroInverters
 * @version 2.0
 */
class InlineResponse2004MicroInverters {
    /**
     * Constructs a new <code>InlineResponse2004MicroInverters</code>.
     * @alias module:model/InlineResponse2004MicroInverters
     * @param id {Number} 
     ...
     * @param sku {String} 
     * @param status {module:model/InlineResponse2004MicroInverters.StatusEnum} The current status of this Microinverter. * `normal` - The microinverter is operating normally. * `power` - There is a production issue. * `micro` - The microinverter is not reporting. * `retired` - The microinverter is retired.
     * @param powerProduced {Number} 
     * @param procLoad {String} 
     * @param paramTable {String} 
     * @param envoySerialNumber {String} 
     * @param energy {module:model/InlineResponse2004Energy} 
    ...
    constructor(id, model, partNumber, serialNumber, sku, status, powerProduced, procLoad, paramTable, envoySerialNumber, energy, gridProfile, lastReportDate) { 
        ...
        InlineResponse2004MicroInverters.initialize(this, id, model, partNumber, serialNumber, sku, status, powerProduced, procLoad, paramTable, envoySerialNumber, energy, gridProfile, lastReportDate);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2004MicroInverters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2004MicroInverters} obj Optional instance to populate.
     * @return {module:model/InlineResponse2004MicroInverters} The populated <code>InlineResponse2004MicroInverters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2004MicroInverters();
            ...
            if (data.hasOwnProperty('energy')) {
                obj['energy'] = InlineResponse2004Energy.constructFromObject(data['energy']);
            }
 ...
 * @member {Number} id
 */
InlineResponse2004MicroInverters.prototype['id'] = undefined;

/**
 * Model number of this Microinverter.
 * @member {String} model
 */
InlineResponse2004MicroInverters.prototype['model'] = undefined;

/**
 * The Enphase part number of this Microinverter.
 * @member {String} part_number
 */
InlineResponse2004MicroInverters.prototype['part_number'] = undefined;

/**
 * The serial number of this Microinverter.
 * @member {String} serial_number
 */
InlineResponse2004MicroInverters.prototype['serial_number'] = undefined;

/**
 * @member {String} sku
 */
InlineResponse2004MicroInverters.prototype['sku'] = undefined;
 ...
 * @member {module:model/InlineResponse2004MicroInverters.StatusEnum} status
 */
InlineResponse2004MicroInverters.prototype['status'] = undefined;

/**
 * @member {Number} power_produced
 */
InlineResponse2004MicroInverters.prototype['power_produced'] = undefined;

/**
 * @member {String} proc_load
 */
InlineResponse2004MicroInverters.prototype['proc_load'] = undefined;

/**
 * @member {String} param_table
 */
InlineResponse2004MicroInverters.prototype['param_table'] = undefined;

/**
 * @member {String} envoy_serial_number
 */
InlineResponse2004MicroInverters.prototype['envoy_serial_number'] = undefined;

/**
 * @member {module:model/InlineResponse2004Energy} energy
 */
InlineResponse2004MicroInverters.prototype['energy'] = undefined;

/**
 * @member {String} grid_profile
 */
InlineResponse2004MicroInverters.prototype['grid_profile'] = undefined;
 ...
 */
InlineResponse2004MicroInverters.prototype['last_report_date'] = undefined;
 ...
 * @readonly
 */
InlineResponse2004MicroInverters['StatusEnum'] = {
...
export default InlineResponse2004MicroInverters;
