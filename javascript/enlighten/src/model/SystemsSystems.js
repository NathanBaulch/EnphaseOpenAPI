...
/**
 * The SystemsSystems model module.
 * @module model/SystemsSystems
 * @version 2.0
 */
class SystemsSystems {
    /**
     * Constructs a new <code>SystemsSystems</code>.
     * @alias module:model/SystemsSystems
     ...
     * @param status {module:model/SystemsSystems.StatusEnum} The current status of the system. You can find this and more in the `meta` property.
    ...
    constructor(systemId, systemName, systemPublicName, reference, otherReferences, country, state, city, postalCode, timezone, connectionType, status, meta) { 
        ...
        SystemsSystems.initialize(this, systemId, systemName, systemPublicName, reference, otherReferences, country, state, city, postalCode, timezone, connectionType, status, meta);
    }
    ...
    /**
     * Constructs a <code>SystemsSystems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SystemsSystems} obj Optional instance to populate.
     * @return {module:model/SystemsSystems} The populated <code>SystemsSystems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SystemsSystems();
 ...
 */
SystemsSystems.prototype['system_id'] = undefined;
 ...
 */
SystemsSystems.prototype['system_name'] = undefined;
 ...
 */
SystemsSystems.prototype['system_public_name'] = undefined;
 ...
 */
SystemsSystems.prototype['reference'] = undefined;
 ...
 */
SystemsSystems.prototype['other_references'] = undefined;
 ...
 */
SystemsSystems.prototype['country'] = undefined;
 ...
 * @member {String} state
 */
SystemsSystems.prototype['state'] = undefined;

/**
 * The name of the city where the system is located.
 * @member {String} city
 */
SystemsSystems.prototype['city'] = undefined;

/**
 * The postal code where the system is located.
 * @member {String} postal_code
 */
SystemsSystems.prototype['postal_code'] = undefined;

/**
 * The timezone of the system.
 * @member {String} timezone
 */
SystemsSystems.prototype['timezone'] = undefined;

/**
 * @member {module:model/ConnectionType} connection_type
 */
SystemsSystems.prototype['connection_type'] = undefined;

/**
 * The current status of the system. You can find this and more in the `meta` property.
 * @member {module:model/SystemsSystems.StatusEnum} status
 */
SystemsSystems.prototype['status'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
SystemsSystems.prototype['meta'] = undefined;
