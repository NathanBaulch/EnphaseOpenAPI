...
class Summary {
     ...
     * @param source {module:model/Summary.SourceEnum} Indicates whether the production of this system is measured by its microinverters (`microinverters`) or by revenue-grade meters (`meter`) installed on the system.
    ...
    constructor(currentPower, energyLifetime, energyToday, lastIntervalEndAt, lastReportAt, modules, operationalAt, sizeW, source, status, summaryDate, systemId) { 
        ...
        Summary.initialize(this, currentPower, energyLifetime, energyToday, lastIntervalEndAt, lastReportAt, modules, operationalAt, sizeW, source, status, summaryDate, systemId);
    }
 ...
 */
Summary.prototype['last_interval_end_at'] = undefined;
 ...
 * @member {module:model/Summary.SourceEnum} source
 */
Summary.prototype['source'] = undefined;

/**
 * @member {module:model/Status} status
 */
Summary.prototype['status'] = undefined;
 ...
 */
Summary.prototype['summary_date'] = undefined;

/**
 * The Enlighten ID of the system.
 * @member {Number} system_id
 */
Summary.prototype['system_id'] = undefined;
