...
/**
 * The StatsIntervals model module.
 * @module model/StatsIntervals
 * @version 2.0
 */
class StatsIntervals {
    /**
     * Constructs a new <code>StatsIntervals</code>.
     * @alias module:model/StatsIntervals
    ...
    constructor(endAt, powr, enwh, devicesReporting) { 
        ...
        StatsIntervals.initialize(this, endAt, powr, enwh, devicesReporting);
    }
    ...
    /**
     * Constructs a <code>StatsIntervals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatsIntervals} obj Optional instance to populate.
     * @return {module:model/StatsIntervals} The populated <code>StatsIntervals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatsIntervals();
