...
/**
 * The ConsumptionLifetime model module.
 * @module model/ConsumptionLifetime
 * @version 2.0
 */
class ConsumptionLifetime {
    /**
     * Constructs a new <code>ConsumptionLifetime</code>.
     * @alias module:model/ConsumptionLifetime
    ...
    constructor(startDate, systemId, consumption, meta) { 
        ...
        ConsumptionLifetime.initialize(this, startDate, systemId, consumption, meta);
    }
    ...
    /**
     * Constructs a <code>ConsumptionLifetime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConsumptionLifetime} obj Optional instance to populate.
     * @return {module:model/ConsumptionLifetime} The populated <code>ConsumptionLifetime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConsumptionLifetime();
 ...
 */
ConsumptionLifetime.prototype['start_date'] = undefined;

/**
 * The identifier of the system.
 * @member {Number} system_id
 */
ConsumptionLifetime.prototype['system_id'] = undefined;
 ...
 */
ConsumptionLifetime.prototype['consumption'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
ConsumptionLifetime.prototype['meta'] = undefined;
...
export default ConsumptionLifetime;
