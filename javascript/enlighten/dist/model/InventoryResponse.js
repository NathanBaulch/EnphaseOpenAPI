      ...
      if (data['envoys']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _InventoryResponseEnvoysInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['inverters']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _InventoryResponseEnvoysInner["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['meters']) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            ...
            _InventoryResponseMetersInner["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
