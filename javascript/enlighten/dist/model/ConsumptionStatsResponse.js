...
var _ConsumptionStatsResponseIntervalsInner = _interopRequireDefault(require("./ConsumptionStatsResponseIntervalsInner"));
...
var ConsumptionStatsResponse = /*#__PURE__*/function () {
  ...
  _createClass(ConsumptionStatsResponse, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('intervals')) {
          obj['intervals'] = _ApiClient["default"].convertToType(data['intervals'], [_ConsumptionStatsResponseIntervalsInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ConsumptionStatsResponse.RequiredProperties),
        _step;
      try {
      ...
      if (data['intervals']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ConsumptionStatsResponseIntervalsInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
