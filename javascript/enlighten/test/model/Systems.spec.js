...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.Systems();
  });
  ...
  describe('Systems', function() {
    it('should create an instance of Systems', function() {
      // uncomment below and update the code to test Systems
      //var instane = new TheEnlightenSystemsApi.Systems();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.Systems);
    });
    ...
    it('should have the property systems (base name: "systems")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.Systems();
