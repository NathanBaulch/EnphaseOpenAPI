...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.ProductionMeterReadings();
  });
  ...
  describe('ProductionMeterReadings', function() {
    it('should create an instance of ProductionMeterReadings', function() {
      // uncomment below and update the code to test ProductionMeterReadings
      //var instane = new TheEnlightenSystemsApi.ProductionMeterReadings();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.ProductionMeterReadings);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.ProductionMeterReadings();
