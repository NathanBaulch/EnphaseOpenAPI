...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2008();
  });
  ...
  describe('InlineResponse2008', function() {
    it('should create an instance of InlineResponse2008', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse2008();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2008);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse2008();
