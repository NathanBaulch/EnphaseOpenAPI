...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2009();
  });
  ...
  describe('InlineResponse2009', function() {
    it('should create an instance of InlineResponse2009', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse2009();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2009);
    });

    it('should have the property startDate (base name: "start_date")', function() {
      // uncomment below and update the code to test the property startDate
      //var instance = new TheEnlightenSystemsApi.InlineResponse2009();
