...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.SystemsSystems();
  });
  ...
  describe('SystemsSystems', function() {
    it('should create an instance of SystemsSystems', function() {
      // uncomment below and update the code to test SystemsSystems
      //var instane = new TheEnlightenSystemsApi.SystemsSystems();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.SystemsSystems);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.SystemsSystems();
