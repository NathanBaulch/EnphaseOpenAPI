...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse20012();
  });
  ...
  describe('InlineResponse20012', function() {
    it('should create an instance of InlineResponse20012', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse20012();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse20012);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse20012();
