...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.EnvoysEnvoys();
  });
  ...
  describe('EnvoysEnvoys', function() {
    it('should create an instance of EnvoysEnvoys', function() {
      // uncomment below and update the code to test EnvoysEnvoys
      //var instane = new TheEnlightenSystemsApi.EnvoysEnvoys();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.EnvoysEnvoys);
    });
    ...
    it('should have the property envoyId (base name: "envoy_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.EnvoysEnvoys();
