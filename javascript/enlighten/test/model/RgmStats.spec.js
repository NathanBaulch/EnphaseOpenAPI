...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.RgmStats();
  });
  ...
  describe('RgmStats', function() {
    it('should create an instance of RgmStats', function() {
      // uncomment below and update the code to test RgmStats
      //var instane = new TheEnlightenSystemsApi.RgmStats();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.RgmStats);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.RgmStats();
