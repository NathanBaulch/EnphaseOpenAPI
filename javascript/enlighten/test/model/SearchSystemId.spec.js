...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.SearchSystemId();
  });
  ...
  describe('SearchSystemId', function() {
    it('should create an instance of SearchSystemId', function() {
      // uncomment below and update the code to test SearchSystemId
      //var instane = new TheEnlightenSystemsApi.SearchSystemId();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.SearchSystemId);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.SearchSystemId();
