...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InvertersSummaryByEnvoyOrSiteMicroInverters();
  });
  ...
  describe('InvertersSummaryByEnvoyOrSiteMicroInverters', function() {
    it('should create an instance of InvertersSummaryByEnvoyOrSiteMicroInverters', function() {
      // uncomment below and update the code to test InvertersSummaryByEnvoyOrSiteMicroInverters
      //var instane = new TheEnlightenSystemsApi.InvertersSummaryByEnvoyOrSiteMicroInverters();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InvertersSummaryByEnvoyOrSiteMicroInverters);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TheEnlightenSystemsApi.InvertersSummaryByEnvoyOrSiteMicroInverters();
