...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.RgmStatsIntervals1();
  });
  ...
  describe('RgmStatsIntervals1', function() {
    it('should create an instance of RgmStatsIntervals1', function() {
      // uncomment below and update the code to test RgmStatsIntervals1
      //var instane = new TheEnlightenSystemsApi.RgmStatsIntervals1();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.RgmStatsIntervals1);
    });

    it('should have the property channel (base name: "channel")', function() {
      // uncomment below and update the code to test the property channel
      //var instance = new TheEnlightenSystemsApi.RgmStatsIntervals1();
