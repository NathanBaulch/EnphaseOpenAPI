...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2006();
  });
  ...
  describe('InlineResponse2006', function() {
    it('should create an instance of InlineResponse2006', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse2006();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2006);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse2006();
