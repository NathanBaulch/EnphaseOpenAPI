...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.MonthlyProduction();
  });
  ...
  describe('MonthlyProduction', function() {
    it('should create an instance of MonthlyProduction', function() {
      // uncomment below and update the code to test MonthlyProduction
      //var instane = new TheEnlightenSystemsApi.MonthlyProduction();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.MonthlyProduction);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.MonthlyProduction();
