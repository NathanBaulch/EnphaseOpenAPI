...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.ConsumptionLifetime();
  });
  ...
  describe('ConsumptionLifetime', function() {
    it('should create an instance of ConsumptionLifetime', function() {
      // uncomment below and update the code to test ConsumptionLifetime
      //var instane = new TheEnlightenSystemsApi.ConsumptionLifetime();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.ConsumptionLifetime);
    });

    it('should have the property startDate (base name: "start_date")', function() {
      // uncomment below and update the code to test the property startDate
      //var instance = new TheEnlightenSystemsApi.ConsumptionLifetime();
