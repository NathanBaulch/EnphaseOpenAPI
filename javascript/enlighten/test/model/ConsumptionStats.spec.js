...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.ConsumptionStats();
  });
  ...
  describe('ConsumptionStats', function() {
    it('should create an instance of ConsumptionStats', function() {
      // uncomment below and update the code to test ConsumptionStats
      //var instane = new TheEnlightenSystemsApi.ConsumptionStats();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.ConsumptionStats);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.ConsumptionStats();
