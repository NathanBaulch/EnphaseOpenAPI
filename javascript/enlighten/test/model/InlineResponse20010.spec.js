...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse20010();
  });
  ...
  describe('InlineResponse20010', function() {
    it('should create an instance of InlineResponse20010', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse20010();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse20010);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse20010();
