...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2004MicroInverters();
  });
  ...
  describe('InlineResponse2004MicroInverters', function() {
    it('should create an instance of InlineResponse2004MicroInverters', function() {
      // uncomment below and update the code to test InlineResponse2004MicroInverters
      //var instane = new TheEnlightenSystemsApi.InlineResponse2004MicroInverters();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2004MicroInverters);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TheEnlightenSystemsApi.InlineResponse2004MicroInverters();
