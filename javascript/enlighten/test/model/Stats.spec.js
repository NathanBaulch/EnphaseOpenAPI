...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.Stats();
  });
  ...
  describe('Stats', function() {
    it('should create an instance of Stats', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.Stats();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.Stats);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.Stats();
