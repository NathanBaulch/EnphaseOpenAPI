...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2007();
  });
  ...
  describe('InlineResponse2007', function() {
    it('should create an instance of InlineResponse2007', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse2007();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2007);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse2007();
