...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheEnlightenSystemsApi.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new TheEnlightenSystemsApi.InlineResponse2001();
      //expect(instance).to.be.a(TheEnlightenSystemsApi.InlineResponse2001);
    });
    ...
    it('should have the property systemId (base name: "system_id")', function() {
      ...
      //var instance = new TheEnlightenSystemsApi.InlineResponse2001();
