...
import SystemOwnerCompany from './SystemOwnerCompany';
...
class SystemOwner {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('company')) {
                obj['company'] = SystemOwnerCompany.constructFromObject(data['company']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['company']) { // data not null
          SystemOwnerCompany.validateJSON(data['company']);
        }
