...
var _TariffSeasonsInnerDaysInnerPeriodsInner = _interopRequireDefault(require("./TariffSeasonsInnerDaysInnerPeriodsInner"));
 ...
 * @version 4.0
 */
var TariffSeasonsInnerDaysInner = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TariffSeasonsInnerDaysInner</code>.
   * @alias module:model/TariffSeasonsInnerDaysInner
   */
  function TariffSeasonsInnerDaysInner() {
    _classCallCheck(this, TariffSeasonsInnerDaysInner);
   ...
   */
  _createClass(TariffSeasonsInnerDaysInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('days')) {
          obj['days'] = _ApiClient["default"].convertToType(data['days'], 'String');
        }
        if (data.hasOwnProperty('must_charge_start')) {
          obj['must_charge_start'] = _ApiClient["default"].convertToType(data['must_charge_start'], 'Number');
        }
        if (data.hasOwnProperty('must_charge_duration')) {
          obj['must_charge_duration'] = _ApiClient["default"].convertToType(data['must_charge_duration'], 'Number');
        }
        if (data.hasOwnProperty('periods')) {
          obj['periods'] = _ApiClient["default"].convertToType(data['periods'], [_TariffSeasonsInnerDaysInnerPeriodsInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['periods']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['periods']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _TariffSeasonsInnerDaysInnerPeriodsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return TariffSeasonsInnerDaysInner;
}();
/**
...
var _default = TariffSeasonsInnerDaysInner;
