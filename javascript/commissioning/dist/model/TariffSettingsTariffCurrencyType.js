 ...
 * @version 4.0
 */
var TariffSettingsTariffCurrencyType = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TariffSettingsTariffCurrencyType</code>.
   * Currency type.
   * @alias module:model/TariffSettingsTariffCurrencyType
   */
  function TariffSettingsTariffCurrencyType() {
    _classCallCheck(this, TariffSettingsTariffCurrencyType);
   ...
   */
  _createClass(TariffSettingsTariffCurrencyType, null, [{
    key: "initialize",
  ...
  return TariffSettingsTariffCurrencyType;
}();
/**
...
var _default = TariffSettingsTariffCurrencyType;
