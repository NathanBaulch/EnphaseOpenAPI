 ...
 * @version 4.0
 */
var GetCompanyUsersResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetCompanyUsersResponse</code>.
   * @alias module:model/GetCompanyUsersResponse
   */
  function GetCompanyUsersResponse() {
    _classCallCheck(this, GetCompanyUsersResponse);
   ...
   */
  _createClass(GetCompanyUsersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('users')) {
          obj['users'] = _ApiClient["default"].convertToType(data['users'], [_GetCompanyUsersResponseUsersInner["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['users']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _GetCompanyUsersResponseUsersInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = GetCompanyUsersResponse;
