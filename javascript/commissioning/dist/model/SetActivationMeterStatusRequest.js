...
var _SystemMeterStatusEnum = _interopRequireDefault(require("./SystemMeterStatusEnum"));
 ...
 * @version 4.0
 */
var SetActivationMeterStatusRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SetActivationMeterStatusRequest</code>.
   * @alias module:model/SetActivationMeterStatusRequest
   */
  function SetActivationMeterStatusRequest() {
    _classCallCheck(this, SetActivationMeterStatusRequest);
   ...
   */
  _createClass(SetActivationMeterStatusRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('status')) {
          obj['status'] = _SystemMeterStatusEnum["default"].constructFromObject(data['status']);
        }
      }
      return obj;
    }
