...
var _SystemHostCompany = _interopRequireDefault(require("./SystemHostCompany"));
...
var SystemHost = /*#__PURE__*/function () {
   ...
   */
  function SystemHost() {
    _classCallCheck(this, SystemHost);
  ...
  _createClass(SystemHost, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('company')) {
          obj['company'] = _SystemHostCompany["default"].constructFromObject(data['company']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['company']) {
        // data not null
        _SystemHostCompany["default"].validateJSON(data['company']);
      }
      return true;
    }
  }]);
