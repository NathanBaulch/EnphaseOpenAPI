...
import SystemDetailsAddress from './SystemDetailsAddress';
import SystemStatusEnum from './SystemStatusEnum';

/**
 * The SystemDetails model module.
 * @module model/SystemDetails
 * @version 4.0
 */
class SystemDetails {
    /**
    ...
    /**
     * Constructs a <code>SystemDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SystemDetails} obj Optional instance to populate.
     * @return {module:model/SystemDetails} The populated <code>SystemDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SystemDetails();
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = SystemDetailsAddress.constructFromObject(data['address']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SystemDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
    ...
    static validateJSON(data) {
        ...
        if (data['address']) { // data not null
          SystemDetailsAddress.validateJSON(data['address']);
        }
        // ensure the json data is a string
 ...
 */
SystemDetails.prototype['system_id'] = undefined;

/**
 * Name of the system.
 * @member {String} name
 */
SystemDetails.prototype['name'] = undefined;
 ...
 */
SystemDetails.prototype['public_name'] = undefined;

/**
 * Timezone to which the system belongs.
 * @member {String} timezone
 */
SystemDetails.prototype['timezone'] = undefined;

/**
 * @member {module:model/SystemDetailsAddress} address
 */
SystemDetails.prototype['address'] = undefined;

/**
 * @member {module:model/SystemConnectionTypeEnum} connection_type
 */
SystemDetails.prototype['connection_type'] = undefined;
 ...
 */
SystemDetails.prototype['energy_lifetime'] = undefined;
 ...
 */
SystemDetails.prototype['last_energy_at'] = undefined;
 ...
 */
SystemDetails.prototype['reference'] = undefined;
 ...
 */
SystemDetails.prototype['other_references'] = undefined;
