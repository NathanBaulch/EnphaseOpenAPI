...
// checks if the SystemOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemOwner{}

// SystemOwner Name of the system owner. Owner must be an Enlighten user. If the user of the API is a self-installer, the owner must be himself. If the query parameter 'expand=owner' passed in the request owner detail will appear in the response.
type SystemOwner struct {
	...
	Company *SystemOwnerCompany `json:"company,omitempty"`
}
...
// SetCompany gets a reference to the given SystemOwnerCompany and assigns it to the Company field.
func (o *SystemOwner) SetCompany(v SystemOwnerCompany) {
	o.Company = &v
}

func (o SystemOwner) MarshalJSON() ([]byte, error) {
...
func (o SystemOwner) ToMap() (map[string]interface{}, error) {
...
type NullableSystemOwner struct {
	value *SystemOwner
	isSet bool
}

func (v NullableSystemOwner) Get() *SystemOwner {
	return v.value
}

func (v *NullableSystemOwner) Set(val *SystemOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemOwner(val *SystemOwner) *NullableSystemOwner {
	return &NullableSystemOwner{value: val, isSet: true}
}

func (v NullableSystemOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
