...
// checks if the GetSelfCompanyBranchesResponseBranchesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSelfCompanyBranchesResponseBranchesInner{}

// GetSelfCompanyBranchesResponseBranchesInner struct for GetSelfCompanyBranchesResponseBranchesInner
type GetSelfCompanyBranchesResponseBranchesInner struct {
...
func NewGetSelfCompanyBranchesResponseBranchesInner() *GetSelfCompanyBranchesResponseBranchesInner {
	this := GetSelfCompanyBranchesResponseBranchesInner{}
	return &this
}
...
func (o GetSelfCompanyBranchesResponseBranchesInner) MarshalJSON() ([]byte, error) {
...
func (o GetSelfCompanyBranchesResponseBranchesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetSelfCompanyBranchesResponseBranchesInner struct {
	value *GetSelfCompanyBranchesResponseBranchesInner
	isSet bool
}

func (v NullableGetSelfCompanyBranchesResponseBranchesInner) Get() *GetSelfCompanyBranchesResponseBranchesInner {
	return v.value
}

func (v *NullableGetSelfCompanyBranchesResponseBranchesInner) Set(val *GetSelfCompanyBranchesResponseBranchesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSelfCompanyBranchesResponseBranchesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSelfCompanyBranchesResponseBranchesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSelfCompanyBranchesResponseBranchesInner(val *GetSelfCompanyBranchesResponseBranchesInner) *NullableGetSelfCompanyBranchesResponseBranchesInner {
	return &NullableGetSelfCompanyBranchesResponseBranchesInner{value: val, isSet: true}
}

func (v NullableGetSelfCompanyBranchesResponseBranchesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSelfCompanyBranchesResponseBranchesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
