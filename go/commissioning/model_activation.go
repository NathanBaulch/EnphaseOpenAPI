...
type Activation struct {
	...
	Owner *ActivationOwner `json:"owner,omitempty"`
	// Enlighten ID of this system owner. System-generated. This field is optional.
	OwnerId *int32 `json:"owner_id,omitempty"`
	Host *ActivationHost `json:"host,omitempty"`
	...
	// Encharge detail.
	Encharge []ActivationEnchargeInner `json:"encharge,omitempty"`
	// Enpower detail.
	Enpower []ActivationEnpowerInner `json:"enpower,omitempty"`
...
// SetOwner gets a reference to the given ActivationOwner and assigns it to the Owner field.
...
// SetHost gets a reference to the given ActivationHost and assigns it to the Host field.
...
func (o *Activation) GetEncharge() []ActivationEnchargeInner {
	if o == nil || IsNil(o.Encharge) {
		var ret []ActivationEnchargeInner
		return ret
	}
	return o.Encharge
}
...
// SetEncharge gets a reference to the given []ActivationEnchargeInner and assigns it to the Encharge field.
...
func (o *Activation) GetEnpower() []ActivationEnpowerInner {
	if o == nil || IsNil(o.Enpower) {
		var ret []ActivationEnpowerInner
		return ret
	}
	return o.Enpower
}
...
// SetEnpower gets a reference to the given []ActivationEnpowerInner and assigns it to the Enpower field.
