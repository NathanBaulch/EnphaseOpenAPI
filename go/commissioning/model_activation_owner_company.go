...
// checks if the ActivationOwnerCompany type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivationOwnerCompany{}

// ActivationOwnerCompany A hash of information about the owner's company. Use the query parameter 'expand=owner.company' to get owner company detail.
type ActivationOwnerCompany struct {
...
func (o ActivationOwnerCompany) MarshalJSON() ([]byte, error) {
...
func (o ActivationOwnerCompany) ToMap() (map[string]interface{}, error) {
...
type NullableActivationOwnerCompany struct {
	value *ActivationOwnerCompany
	isSet bool
}

func (v NullableActivationOwnerCompany) Get() *ActivationOwnerCompany {
	return v.value
}

func (v *NullableActivationOwnerCompany) Set(val *ActivationOwnerCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableActivationOwnerCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableActivationOwnerCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivationOwnerCompany(val *ActivationOwnerCompany) *NullableActivationOwnerCompany {
	return &NullableActivationOwnerCompany{value: val, isSet: true}
}

func (v NullableActivationOwnerCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivationOwnerCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
