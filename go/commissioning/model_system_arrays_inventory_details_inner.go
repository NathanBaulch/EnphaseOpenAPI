...
// checks if the SystemArraysInventoryDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemArraysInventoryDetailsInner{}

// SystemArraysInventoryDetailsInner struct for SystemArraysInventoryDetailsInner
type SystemArraysInventoryDetailsInner struct {
	// Device type.
...
func NewSystemArraysInventoryDetailsInner() *SystemArraysInventoryDetailsInner {
	this := SystemArraysInventoryDetailsInner{}
	return &this
}
...
func (o SystemArraysInventoryDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o SystemArraysInventoryDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSystemArraysInventoryDetailsInner struct {
	value *SystemArraysInventoryDetailsInner
	isSet bool
}

func (v NullableSystemArraysInventoryDetailsInner) Get() *SystemArraysInventoryDetailsInner {
	return v.value
}

func (v *NullableSystemArraysInventoryDetailsInner) Set(val *SystemArraysInventoryDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemArraysInventoryDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemArraysInventoryDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemArraysInventoryDetailsInner(val *SystemArraysInventoryDetailsInner) *NullableSystemArraysInventoryDetailsInner {
	return &NullableSystemArraysInventoryDetailsInner{value: val, isSet: true}
}

func (v NullableSystemArraysInventoryDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemArraysInventoryDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
