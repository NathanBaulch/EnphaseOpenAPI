...
// checks if the SystemArrays type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemArrays{}

// SystemArrays struct for SystemArrays
type SystemArrays struct {
	// System ID.
	...
	Arrays []SystemArray `json:"arrays,omitempty"`
	// List of active inverter serial numbers.
	Inventory []string `json:"inventory,omitempty"`
	InventoryDetails []SystemArraysInventoryDetailsInner `json:"inventory_details,omitempty"`
	Layers []SystemArraysLayersInner `json:"layers,omitempty"`
}
...
// SetArrays gets a reference to the given []SystemArray and assigns it to the Arrays field.
...
func (o *SystemArrays) GetInventoryDetails() []SystemArraysInventoryDetailsInner {
	if o == nil || IsNil(o.InventoryDetails) {
		var ret []SystemArraysInventoryDetailsInner
		return ret
	}
...
// SetInventoryDetails gets a reference to the given []SystemArraysInventoryDetailsInner and assigns it to the InventoryDetails field.
...
func (o *SystemArrays) GetLayers() []SystemArraysLayersInner {
	if o == nil || IsNil(o.Layers) {
		var ret []SystemArraysLayersInner
		return ret
	}
	return o.Layers
}
...
// SetLayers gets a reference to the given []SystemArraysLayersInner and assigns it to the Layers field.
func (o *SystemArrays) SetLayers(v []SystemArraysLayersInner) {
	o.Layers = v
}

func (o SystemArrays) MarshalJSON() ([]byte, error) {
...
func (o SystemArrays) ToMap() (map[string]interface{}, error) {
...
type NullableSystemArrays struct {
	value *SystemArrays
	isSet bool
}

func (v NullableSystemArrays) Get() *SystemArrays {
	return v.value
}

func (v *NullableSystemArrays) Set(val *SystemArrays) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemArrays) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemArrays) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemArrays(val *SystemArrays) *NullableSystemArrays {
	return &NullableSystemArrays{value: val, isSet: true}
}

func (v NullableSystemArrays) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemArrays) UnmarshalJSON(src []byte) error {
	v.isSet = true
