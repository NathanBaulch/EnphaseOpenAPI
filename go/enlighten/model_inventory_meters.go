...
// InventoryMeters struct for InventoryMeters
type InventoryMeters struct {
	Sn string `json:"sn"`
...
func (o InventoryMeters) MarshalJSON() ([]byte, error) {
...
type NullableInventoryMeters struct {
	value *InventoryMeters
	isSet bool
}

func (v NullableInventoryMeters) Get() *InventoryMeters {
	return v.value
}

func (v *NullableInventoryMeters) Set(val *InventoryMeters) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryMeters) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryMeters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryMeters(val *InventoryMeters) *NullableInventoryMeters {
	return &NullableInventoryMeters{value: val, isSet: true}
}

func (v NullableInventoryMeters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryMeters) UnmarshalJSON(src []byte) error {
	v.isSet = true
