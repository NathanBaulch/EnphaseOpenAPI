...
// SystemsSystems struct for SystemsSystems
type SystemsSystems struct {
...
func (o SystemsSystems) MarshalJSON() ([]byte, error) {
...
type NullableSystemsSystems struct {
	value *SystemsSystems
	isSet bool
}

func (v NullableSystemsSystems) Get() *SystemsSystems {
	return v.value
}

func (v *NullableSystemsSystems) Set(val *SystemsSystems) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemsSystems) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemsSystems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemsSystems(val *SystemsSystems) *NullableSystemsSystems {
	return &NullableSystemsSystems{value: val, isSet: true}
}

func (v NullableSystemsSystems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemsSystems) UnmarshalJSON(src []byte) error {
	v.isSet = true
