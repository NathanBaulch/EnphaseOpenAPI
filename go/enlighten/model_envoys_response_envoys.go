...
// EnvoysResponseEnvoys struct for EnvoysResponseEnvoys
type EnvoysResponseEnvoys struct {
...
func (o EnvoysResponseEnvoys) MarshalJSON() ([]byte, error) {
...
type NullableEnvoysResponseEnvoys struct {
	value *EnvoysResponseEnvoys
	isSet bool
}

func (v NullableEnvoysResponseEnvoys) Get() *EnvoysResponseEnvoys {
	return v.value
}

func (v *NullableEnvoysResponseEnvoys) Set(val *EnvoysResponseEnvoys) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvoysResponseEnvoys) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvoysResponseEnvoys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvoysResponseEnvoys(val *EnvoysResponseEnvoys) *NullableEnvoysResponseEnvoys {
	return &NullableEnvoysResponseEnvoys{value: val, isSet: true}
}

func (v NullableEnvoysResponseEnvoys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvoysResponseEnvoys) UnmarshalJSON(src []byte) error {
	v.isSet = true
