...
type NullableProductionMeterReadingsResponse struct {
	value *ProductionMeterReadingsResponse
	isSet bool
}

func (v NullableProductionMeterReadingsResponse) Get() *ProductionMeterReadingsResponse {
	return v.value
}

func (v *NullableProductionMeterReadingsResponse) Set(val *ProductionMeterReadingsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProductionMeterReadingsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProductionMeterReadingsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductionMeterReadingsResponse(val *ProductionMeterReadingsResponse) *NullableProductionMeterReadingsResponse {
	return &NullableProductionMeterReadingsResponse{value: val, isSet: true}
}

func (v NullableProductionMeterReadingsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductionMeterReadingsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
