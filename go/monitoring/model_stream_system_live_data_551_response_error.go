...
// checks if the StreamSystemLiveData551ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData551ResponseError{}

// StreamSystemLiveData551ResponseError struct for StreamSystemLiveData551ResponseError
type StreamSystemLiveData551ResponseError struct {
	// 551
...
func NewStreamSystemLiveData551ResponseError() *StreamSystemLiveData551ResponseError {
	this := StreamSystemLiveData551ResponseError{}
	return &this
}
...
func (o StreamSystemLiveData551ResponseError) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData551ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData551ResponseError struct {
	value *StreamSystemLiveData551ResponseError
	isSet bool
}

func (v NullableStreamSystemLiveData551ResponseError) Get() *StreamSystemLiveData551ResponseError {
	return v.value
}

func (v *NullableStreamSystemLiveData551ResponseError) Set(val *StreamSystemLiveData551ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData551ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData551ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData551ResponseError(val *StreamSystemLiveData551ResponseError) *NullableStreamSystemLiveData551ResponseError {
	return &NullableStreamSystemLiveData551ResponseError{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData551ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData551ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
