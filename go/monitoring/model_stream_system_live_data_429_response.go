...
// checks if the StreamSystemLiveData429Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData429Response{}

// StreamSystemLiveData429Response struct for StreamSystemLiveData429Response
type StreamSystemLiveData429Response struct {
	Error *StreamSystemLiveData429ResponseError `json:"error,omitempty"`
...
func NewStreamSystemLiveData429Response() *StreamSystemLiveData429Response {
	this := StreamSystemLiveData429Response{}
	return &this
}
...
func (o *StreamSystemLiveData429Response) GetError() StreamSystemLiveData429ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret StreamSystemLiveData429ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given StreamSystemLiveData429ResponseError and assigns it to the Error field.
...
func (o StreamSystemLiveData429Response) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData429Response) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData429Response struct {
	value *StreamSystemLiveData429Response
	isSet bool
}

func (v NullableStreamSystemLiveData429Response) Get() *StreamSystemLiveData429Response {
	return v.value
}

func (v *NullableStreamSystemLiveData429Response) Set(val *StreamSystemLiveData429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData429Response(val *StreamSystemLiveData429Response) *NullableStreamSystemLiveData429Response {
	return &NullableStreamSystemLiveData429Response{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
