...
// checks if the BatteryDeviceTelemetry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatteryDeviceTelemetry{}

// BatteryDeviceTelemetry struct for BatteryDeviceTelemetry
type BatteryDeviceTelemetry struct {
	// System ID.
	...
	Intervals []BatteryDeviceTelemetryIntervalsInner `json:"intervals,omitempty"`
	// Last reported timestamp.
	LastReportedTime *int32 `json:"last_reported_time,omitempty"`
	// Last reported soc percentage.
	LastReportedSoc *string `json:"last_reported_soc,omitempty"`
}
...
func (o *BatteryDeviceTelemetry) GetIntervals() []BatteryDeviceTelemetryIntervalsInner {
	if o == nil || IsNil(o.Intervals) {
		var ret []BatteryDeviceTelemetryIntervalsInner
		return ret
	}
	return o.Intervals
}
...
// SetIntervals gets a reference to the given []BatteryDeviceTelemetryIntervalsInner and assigns it to the Intervals field.
...
// SetLastReportedTime gets a reference to the given int32 and assigns it to the LastReportedTime field.
func (o *BatteryDeviceTelemetry) SetLastReportedTime(v int32) {
	o.LastReportedTime = &v
}

// GetLastReportedSoc returns the LastReportedSoc field value if set, zero value otherwise.
func (o *BatteryDeviceTelemetry) GetLastReportedSoc() string {
	if o == nil || IsNil(o.LastReportedSoc) {
		var ret string
		return ret
	}
	return *o.LastReportedSoc
}

// GetLastReportedSocOk returns a tuple with the LastReportedSoc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BatteryDeviceTelemetry) GetLastReportedSocOk() (*string, bool) {
	if o == nil || IsNil(o.LastReportedSoc) {
		return nil, false
	}
	return o.LastReportedSoc, true
}
...
// SetLastReportedSoc gets a reference to the given string and assigns it to the LastReportedSoc field.
func (o *BatteryDeviceTelemetry) SetLastReportedSoc(v string) {
	o.LastReportedSoc = &v
}

func (o BatteryDeviceTelemetry) MarshalJSON() ([]byte, error) {
...
func (o BatteryDeviceTelemetry) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastReportedSoc) {
		toSerialize["last_reported_soc"] = o.LastReportedSoc
	}
	return toSerialize, nil
}

type NullableBatteryDeviceTelemetry struct {
	value *BatteryDeviceTelemetry
	isSet bool
}

func (v NullableBatteryDeviceTelemetry) Get() *BatteryDeviceTelemetry {
	return v.value
}

func (v *NullableBatteryDeviceTelemetry) Set(val *BatteryDeviceTelemetry) {
	v.value = val
	v.isSet = true
}

func (v NullableBatteryDeviceTelemetry) IsSet() bool {
	return v.isSet
}

func (v *NullableBatteryDeviceTelemetry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatteryDeviceTelemetry(val *BatteryDeviceTelemetry) *NullableBatteryDeviceTelemetry {
	return &NullableBatteryDeviceTelemetry{value: val, isSet: true}
}

func (v NullableBatteryDeviceTelemetry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatteryDeviceTelemetry) UnmarshalJSON(src []byte) error {
	v.isSet = true
