...
// checks if the StreamSystemLiveData550Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData550Response{}

// StreamSystemLiveData550Response struct for StreamSystemLiveData550Response
type StreamSystemLiveData550Response struct {
	Error *StreamSystemLiveData550ResponseError `json:"error,omitempty"`
...
func NewStreamSystemLiveData550Response() *StreamSystemLiveData550Response {
	this := StreamSystemLiveData550Response{}
	return &this
}
...
func (o *StreamSystemLiveData550Response) GetError() StreamSystemLiveData550ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret StreamSystemLiveData550ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given StreamSystemLiveData550ResponseError and assigns it to the Error field.
...
func (o StreamSystemLiveData550Response) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData550Response) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData550Response struct {
	value *StreamSystemLiveData550Response
	isSet bool
}

func (v NullableStreamSystemLiveData550Response) Get() *StreamSystemLiveData550Response {
	return v.value
}

func (v *NullableStreamSystemLiveData550Response) Set(val *StreamSystemLiveData550Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData550Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData550Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData550Response(val *StreamSystemLiveData550Response) *NullableStreamSystemLiveData550Response {
	return &NullableStreamSystemLiveData550Response{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData550Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData550Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
