...
// checks if the StreamSystemLiveData463Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData463Response{}

// StreamSystemLiveData463Response struct for StreamSystemLiveData463Response
type StreamSystemLiveData463Response struct {
	Error *StreamSystemLiveData463ResponseError `json:"error,omitempty"`
...
func NewStreamSystemLiveData463Response() *StreamSystemLiveData463Response {
	this := StreamSystemLiveData463Response{}
	return &this
}
...
func (o *StreamSystemLiveData463Response) GetError() StreamSystemLiveData463ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret StreamSystemLiveData463ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given StreamSystemLiveData463ResponseError and assigns it to the Error field.
...
func (o StreamSystemLiveData463Response) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData463Response) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData463Response struct {
	value *StreamSystemLiveData463Response
	isSet bool
}

func (v NullableStreamSystemLiveData463Response) Get() *StreamSystemLiveData463Response {
	return v.value
}

func (v *NullableStreamSystemLiveData463Response) Set(val *StreamSystemLiveData463Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData463Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData463Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData463Response(val *StreamSystemLiveData463Response) *NullableStreamSystemLiveData463Response {
	return &NullableStreamSystemLiveData463Response{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData463Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData463Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
