...
// checks if the StreamSystemLiveData403ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData403ResponseError{}

// StreamSystemLiveData403ResponseError struct for StreamSystemLiveData403ResponseError
type StreamSystemLiveData403ResponseError struct {
	// 403
...
func NewStreamSystemLiveData403ResponseError() *StreamSystemLiveData403ResponseError {
	this := StreamSystemLiveData403ResponseError{}
	return &this
}
...
func (o StreamSystemLiveData403ResponseError) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData403ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData403ResponseError struct {
	value *StreamSystemLiveData403ResponseError
	isSet bool
}

func (v NullableStreamSystemLiveData403ResponseError) Get() *StreamSystemLiveData403ResponseError {
	return v.value
}

func (v *NullableStreamSystemLiveData403ResponseError) Set(val *StreamSystemLiveData403ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData403ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData403ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData403ResponseError(val *StreamSystemLiveData403ResponseError) *NullableStreamSystemLiveData403ResponseError {
	return &NullableStreamSystemLiveData403ResponseError{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData403ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData403ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
