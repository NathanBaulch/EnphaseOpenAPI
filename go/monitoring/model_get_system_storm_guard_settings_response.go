...
// checks if the GetSystemStormGuardSettingsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemStormGuardSettingsResponse{}

// GetSystemStormGuardSettingsResponse struct for GetSystemStormGuardSettingsResponse
type GetSystemStormGuardSettingsResponse struct {
...
func NewGetSystemStormGuardSettingsResponse() *GetSystemStormGuardSettingsResponse {
	this := GetSystemStormGuardSettingsResponse{}
	return &this
}
...
func (o GetSystemStormGuardSettingsResponse) MarshalJSON() ([]byte, error) {
...
func (o GetSystemStormGuardSettingsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGetSystemStormGuardSettingsResponse struct {
	value *GetSystemStormGuardSettingsResponse
	isSet bool
}

func (v NullableGetSystemStormGuardSettingsResponse) Get() *GetSystemStormGuardSettingsResponse {
	return v.value
}

func (v *NullableGetSystemStormGuardSettingsResponse) Set(val *GetSystemStormGuardSettingsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemStormGuardSettingsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemStormGuardSettingsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemStormGuardSettingsResponse(val *GetSystemStormGuardSettingsResponse) *NullableGetSystemStormGuardSettingsResponse {
	return &NullableGetSystemStormGuardSettingsResponse{value: val, isSet: true}
}

func (v NullableGetSystemStormGuardSettingsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemStormGuardSettingsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
