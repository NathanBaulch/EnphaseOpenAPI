...
// checks if the StreamSystemLiveData401Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData401Response{}

// StreamSystemLiveData401Response struct for StreamSystemLiveData401Response
type StreamSystemLiveData401Response struct {
	Error *StreamSystemLiveData401ResponseError `json:"error,omitempty"`
...
func NewStreamSystemLiveData401Response() *StreamSystemLiveData401Response {
	this := StreamSystemLiveData401Response{}
	return &this
}
...
func (o *StreamSystemLiveData401Response) GetError() StreamSystemLiveData401ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret StreamSystemLiveData401ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given StreamSystemLiveData401ResponseError and assigns it to the Error field.
...
func (o StreamSystemLiveData401Response) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData401Response) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData401Response struct {
	value *StreamSystemLiveData401Response
	isSet bool
}

func (v NullableStreamSystemLiveData401Response) Get() *StreamSystemLiveData401Response {
	return v.value
}

func (v *NullableStreamSystemLiveData401Response) Set(val *StreamSystemLiveData401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData401Response(val *StreamSystemLiveData401Response) *NullableStreamSystemLiveData401Response {
	return &NullableStreamSystemLiveData401Response{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
