...
// checks if the StreamSystemLiveData403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData403Response{}

// StreamSystemLiveData403Response struct for StreamSystemLiveData403Response
type StreamSystemLiveData403Response struct {
	Error *StreamSystemLiveData403ResponseError `json:"error,omitempty"`
...
func NewStreamSystemLiveData403Response() *StreamSystemLiveData403Response {
	this := StreamSystemLiveData403Response{}
	return &this
}
...
func (o *StreamSystemLiveData403Response) GetError() StreamSystemLiveData403ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret StreamSystemLiveData403ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given StreamSystemLiveData403ResponseError and assigns it to the Error field.
...
func (o StreamSystemLiveData403Response) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData403Response) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData403Response struct {
	value *StreamSystemLiveData403Response
	isSet bool
}

func (v NullableStreamSystemLiveData403Response) Get() *StreamSystemLiveData403Response {
	return v.value
}

func (v *NullableStreamSystemLiveData403Response) Set(val *StreamSystemLiveData403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData403Response(val *StreamSystemLiveData403Response) *NullableStreamSystemLiveData403Response {
	return &NullableStreamSystemLiveData403Response{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
