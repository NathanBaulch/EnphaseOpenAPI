...
// checks if the StreamSystemLiveData468ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData468ResponseError{}

// StreamSystemLiveData468ResponseError struct for StreamSystemLiveData468ResponseError
type StreamSystemLiveData468ResponseError struct {
	// 468
...
func NewStreamSystemLiveData468ResponseError() *StreamSystemLiveData468ResponseError {
	this := StreamSystemLiveData468ResponseError{}
	return &this
}
...
func (o StreamSystemLiveData468ResponseError) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData468ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData468ResponseError struct {
	value *StreamSystemLiveData468ResponseError
	isSet bool
}

func (v NullableStreamSystemLiveData468ResponseError) Get() *StreamSystemLiveData468ResponseError {
	return v.value
}

func (v *NullableStreamSystemLiveData468ResponseError) Set(val *StreamSystemLiveData468ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData468ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData468ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData468ResponseError(val *StreamSystemLiveData468ResponseError) *NullableStreamSystemLiveData468ResponseError {
	return &NullableStreamSystemLiveData468ResponseError{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData468ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData468ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
