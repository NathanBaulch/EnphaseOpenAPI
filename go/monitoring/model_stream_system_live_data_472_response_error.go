...
// checks if the StreamSystemLiveData472ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamSystemLiveData472ResponseError{}

// StreamSystemLiveData472ResponseError struct for StreamSystemLiveData472ResponseError
type StreamSystemLiveData472ResponseError struct {
	// 472
...
func NewStreamSystemLiveData472ResponseError() *StreamSystemLiveData472ResponseError {
	this := StreamSystemLiveData472ResponseError{}
	return &this
}
...
func (o StreamSystemLiveData472ResponseError) MarshalJSON() ([]byte, error) {
...
func (o StreamSystemLiveData472ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableStreamSystemLiveData472ResponseError struct {
	value *StreamSystemLiveData472ResponseError
	isSet bool
}

func (v NullableStreamSystemLiveData472ResponseError) Get() *StreamSystemLiveData472ResponseError {
	return v.value
}

func (v *NullableStreamSystemLiveData472ResponseError) Set(val *StreamSystemLiveData472ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamSystemLiveData472ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamSystemLiveData472ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamSystemLiveData472ResponseError(val *StreamSystemLiveData472ResponseError) *NullableStreamSystemLiveData472ResponseError {
	return &NullableStreamSystemLiveData472ResponseError{value: val, isSet: true}
}

func (v NullableStreamSystemLiveData472ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamSystemLiveData472ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
