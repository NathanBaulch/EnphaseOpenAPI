...
def lazy_import():
    ...
    globals()['InvertersSummaryByEnvoyOrSiteEnergy'] = InvertersSummaryByEnvoyOrSiteEnergy


class InvertersSummaryByEnvoyOrSiteMicroInverters(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'energy': (InvertersSummaryByEnvoyOrSiteEnergy,),  # noqa: E501
    ...
    def __init__(self, id, model, part_number, serial_number, sku, status, power_produced, proc_load, param_table, envoy_serial_number, energy, grid_profile, last_report_date, *args, **kwargs):  # noqa: E501
        """InvertersSummaryByEnvoyOrSiteMicroInverters - a model defined in OpenAPI
        ...
        Args:
            ...
            energy (InvertersSummaryByEnvoyOrSiteEnergy):
            grid_profile (str):
