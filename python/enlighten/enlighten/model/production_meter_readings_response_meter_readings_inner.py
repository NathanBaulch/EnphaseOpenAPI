...
class ProductionMeterReadingsResponseMeterReadingsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, serial_number, value, read_at, *args, **kwargs):  # noqa: E501
        """ProductionMeterReadingsResponseMeterReadingsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, serial_number, value, read_at, *args, **kwargs):  # noqa: E501
        """ProductionMeterReadingsResponseMeterReadingsInner - a model defined in OpenAPI
