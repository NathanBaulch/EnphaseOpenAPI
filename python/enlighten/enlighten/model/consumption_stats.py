...
class ConsumptionStats(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'meta': (Meta,),  # noqa: E501
            'intervals': ([ConsumptionStatsIntervals],),  # noqa: E501
        }
    ...
    def __init__(self, system_id, total_devices, meta, intervals, *args, **kwargs):  # noqa: E501
        """ConsumptionStats - a model defined in OpenAPI

        Args:
            system_id (int): Enlighten ID for this system.
            total_devices (int): Number of active consumption meters for this system.
            meta (Meta):
            intervals ([ConsumptionStatsIntervals]): A list of intervals between the requested start and end times.
