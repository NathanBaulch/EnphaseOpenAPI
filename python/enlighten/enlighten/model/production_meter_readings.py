...
class ProductionMeterReadings(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'meter_readings': ([ProductionMeterReadingsMeterReadings],),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def __init__(self, system_id, meter_readings, meta, *args, **kwargs):  # noqa: E501
        """ProductionMeterReadings - a model defined in OpenAPI

        Args:
            system_id (int):
            meter_readings ([ProductionMeterReadingsMeterReadings]):
            meta (Meta):
