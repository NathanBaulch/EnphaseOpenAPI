...
class EnvoysResponseEnvoysInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, envoy_id, last_report_at, name, part_number, serial_number, status, *args, **kwargs):  # noqa: E501
        """EnvoysResponseEnvoysInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, envoy_id, last_report_at, name, part_number, serial_number, status, *args, **kwargs):  # noqa: E501
        """EnvoysResponseEnvoysInner - a model defined in OpenAPI
