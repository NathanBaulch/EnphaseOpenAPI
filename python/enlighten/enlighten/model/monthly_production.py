...
class MonthlyProduction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'meter_readings': ([MonthlyProductionMeterReadings],),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def __init__(self, system_id, start_date, end_date, production_wh, meter_readings, meta, *args, **kwargs):  # noqa: E501
        """MonthlyProduction - a model defined in OpenAPI
        ...
        Args:
            ...
            meter_readings ([MonthlyProductionMeterReadings]): If the system has any revenue-grade meters installed, the meter readings at the beginning and end of the reporting period are included here. Otherwise, the array is empty.
            meta (Meta):
