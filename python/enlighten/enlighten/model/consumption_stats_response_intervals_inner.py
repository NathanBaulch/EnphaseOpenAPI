...
class ConsumptionStatsResponseIntervalsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, end_at, enwh, devices_reporting, *args, **kwargs):  # noqa: E501
        """ConsumptionStatsResponseIntervalsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, end_at, enwh, devices_reporting, *args, **kwargs):  # noqa: E501
        """ConsumptionStatsResponseIntervalsInner - a model defined in OpenAPI
