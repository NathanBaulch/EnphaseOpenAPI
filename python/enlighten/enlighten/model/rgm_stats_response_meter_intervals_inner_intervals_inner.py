...
class RgmStatsResponseMeterIntervalsInnerIntervalsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channel, end_at, wh_del, curr_w, *args, **kwargs):  # noqa: E501
        """RgmStatsResponseMeterIntervalsInnerIntervalsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel, end_at, wh_del, curr_w, *args, **kwargs):  # noqa: E501
        """RgmStatsResponseMeterIntervalsInnerIntervalsInner - a model defined in OpenAPI
