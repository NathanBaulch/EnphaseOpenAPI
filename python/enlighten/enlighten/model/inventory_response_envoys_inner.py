...
class InventoryResponseEnvoysInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sn, model, sku, *args, **kwargs):  # noqa: E501
        """InventoryResponseEnvoysInner - a model defined in OpenAPI
