...
SummaryDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'summary_date': typing.Union[SummaryDateSchema, str, date, ],
    },
    total=False
)
...
request_query_summary_date = api_client.QueryParameter(
    name="summary_date",
    style=api_client.ParameterStyle.FORM,
    schema=SummaryDateSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = SummaryResponse
