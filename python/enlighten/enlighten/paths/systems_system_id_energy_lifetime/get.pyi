...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'production': typing.Union[ProductionSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = EnergyLifetimeResponse
...
class EnergyLifetime(BaseApi):
    ...
    def energy_lifetime(
        ...
        return self._energy_lifetime_oapg(
