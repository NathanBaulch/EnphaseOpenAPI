...
SchemaFor200ResponseBodyApplicationJson = ConsumptionStatsResponse
...
class ConsumptionStats(BaseApi):
    ...
    def consumption_stats(
        ...
        return self._consumption_stats_oapg(
