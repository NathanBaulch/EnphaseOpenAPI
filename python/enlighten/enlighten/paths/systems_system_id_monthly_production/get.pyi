...
SchemaFor200ResponseBodyApplicationJson = MonthlyProductionResponse
...
class MonthlyProduction(BaseApi):
    ...
    def monthly_production(
        ...
        return self._monthly_production_oapg(
