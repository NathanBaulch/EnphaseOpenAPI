...
SchemaFor200ResponseBodyApplicationJson = ConsumptionLifetimeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _consumption_lifetime_oapg(
        self,
...
class ConsumptionLifetime(BaseApi):
    ...
    def consumption_lifetime(
        ...
        return self._consumption_lifetime_oapg(
