...
SchemaFor200ResponseBodyApplicationJson = SearchSystemIdResponse
...
class SearchSystemId(BaseApi):
    ...
    def search_system_id(
        ...
        return self._search_system_id_oapg(
