...
SchemaFor200ResponseBodyApplicationJson = ProductionMeterReadingsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _production_meter_readings_oapg(
        self,
...
class ProductionMeterReadings(BaseApi):
    ...
    def production_meter_readings(
        ...
        return self._production_meter_readings_oapg(
