# monitoring.model.get_system_energy_export_telemetry_response.GetSystemEnergyExportTelemetryResponse
...
**total_devices** | decimal.Decimal, int,  | decimal.Decimal,  | Number of production meters in the site. | [optional] 
...
**wh_exported** | decimal.Decimal, int,  | decimal.Decimal,  | Energy exported (in Watt-Hours) during that period. | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
