...
class GetSystemConsumptionLifetimeResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "start_date", "consumption", "meta", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["consumption"]) -> typing.Union[MetaOapg.properties.consumption, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "start_date", "consumption", "meta", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        consumption: typing.Union[MetaOapg.properties.consumption, list, tuple, schemas.Unset] = schemas.unset,
