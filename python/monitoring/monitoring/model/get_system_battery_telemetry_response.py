...
class GetSystemBatteryTelemetryResponse(
    ...
    class MetaOapg:
        ...
        class properties:
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                class charge(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enwh", "devices_reporting", ], str]):
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enwh", "devices_reporting", ], str]):
                                ...
                                class soc(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["percent", "devices_reporting", ], str]):
                                        # dict_instance[name] accessor
                                        return super().__getitem__(name)
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["percent", "devices_reporting", ], str]):
                                        return super().get_item_oapg(name)
            ...
            last_reported_aggregate_soc = schemas.StrSchema
            __annotations__ = {
                "system_id": system_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["last_reported_aggregate_soc"]) -> MetaOapg.properties.last_reported_aggregate_soc: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "granularity", "total_devices", "start_at", "end_at", "items", "intervals", "last_reported_aggregate_soc", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["last_reported_aggregate_soc"]) -> typing.Union[MetaOapg.properties.last_reported_aggregate_soc, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "granularity", "total_devices", "start_at", "end_at", "items", "intervals", "last_reported_aggregate_soc", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        last_reported_aggregate_soc: typing.Union[MetaOapg.properties.last_reported_aggregate_soc, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
