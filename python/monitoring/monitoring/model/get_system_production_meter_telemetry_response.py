...
class GetSystemProductionMeterTelemetryResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "granularity", "total_devices", "start_at", "end_at", "items", "intervals", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "granularity", "total_devices", "start_at", "end_at", "items", "intervals", ], str]):
        return super().get_item_oapg(name)
