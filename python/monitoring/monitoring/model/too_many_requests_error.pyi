...
class TooManyRequestsError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "details", "code", "period", "period_start", "period_end", "limit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "details", "code", "period", "period_start", "period_end", "limit", ], str]):
