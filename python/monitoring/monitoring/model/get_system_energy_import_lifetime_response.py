...
class GetSystemEnergyImportLifetimeResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["import"]) -> MetaOapg.properties._import: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "start_date", "import", "meta", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["import"]) -> typing.Union[MetaOapg.properties._import, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "start_date", "import", "meta", ], str]):
