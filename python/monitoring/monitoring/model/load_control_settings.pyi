            ...
            class load_control_data(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "load_name", "owner_can_override", "mode", "soc_low", "soc_high", "status", "essential_start_time", "essential_end_time", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "load_name", "owner_can_override", "mode", "soc_low", "soc_high", "status", "essential_start_time", "essential_end_time", ], str]):
