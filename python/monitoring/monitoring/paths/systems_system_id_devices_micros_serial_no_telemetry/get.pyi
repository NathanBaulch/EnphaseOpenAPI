...
GranularitySchema = TelemetryGranularityEnum
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'start_at': typing.Union[StartAtSchema, decimal.Decimal, int, ],
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'serial_no': typing.Union[SerialNoSchema, str, ],
    }
)
...
request_path_serial_no = api_client.PathParameter(
    name="serial_no",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SerialNoSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = GetSystemMicroDeviceTelemetryResponse
...
SchemaFor403ResponseBodyApplicationJson = ClientError
...
SchemaFor404ResponseBodyApplicationJson = ClientError
...
SchemaFor405ResponseBodyApplicationJson = MethodNotAllowedError
...
SchemaFor501ResponseBodyApplicationJson = NotImplementedError
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_micro_device_telemetry_oapg(
        self,
...
class GetSystemMicroDeviceTelemetry(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_micro_device_telemetry(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_system_micro_device_telemetry(
        ...
        return self._get_system_micro_device_telemetry_oapg(
