...
ProductionSchema = SystemEnergyLifetimeProductionEnum
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'production': typing.Union[ProductionSchema, ],
    },
    total=False
)
...
request_query_production = api_client.QueryParameter(
    name="production",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = GetSystemEnergyLifetimeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_energy_lifetime_oapg(
        self,
...
class GetSystemEnergyLifetime(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_energy_lifetime(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_system_energy_lifetime(
        ...
        return self._get_system_energy_lifetime_oapg(
