...
# body param
SchemaForRequestBodyApplicationJson = UpdateSystemBatterySettingsRequest


request_body_battery_settings = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = BatterySettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_system_battery_settings_oapg(
        self,
    ...
    def _update_system_battery_settings_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_battery_settings.serialize(body, content_type)
...
class UpdateSystemBatterySettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_system_battery_settings(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_system_battery_settings(
        ...
        return self._update_system_battery_settings_oapg(
            body=body,
