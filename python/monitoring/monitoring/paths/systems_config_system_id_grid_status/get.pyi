...
SchemaFor200ResponseBodyApplicationJson = GetSystemGridStatusSettingsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_grid_status_settings_oapg(
        self,
...
class GetSystemGridStatusSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_grid_status_settings(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_system_grid_status_settings(
        ...
        return self._get_system_grid_status_settings_oapg(
