...
SchemaFor200ResponseBodyApplicationJson = GetSystemSummaryResponse
...
class GetSystemSummary(BaseApi):
    ...
    def get_system_summary(
        ...
        return self._get_system_summary_oapg(
