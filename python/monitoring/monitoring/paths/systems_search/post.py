...
# body param
SchemaForRequestBodyApplicationJson = SearchSystemsRequest
...
SchemaFor200ResponseBodyApplicationJson = SearchSystemsResponse
...
class SearchSystems(BaseApi):
    ...
    def search_systems(
        ...
        return self._search_systems_oapg(
            body=body,
