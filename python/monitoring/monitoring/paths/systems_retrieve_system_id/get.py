...
# Query params
SerialNumSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'serial_num': typing.Union[SerialNumSchema, str, ],
    }
)
...
request_query_serial_num = api_client.QueryParameter(
    name="serial_num",
    style=api_client.ParameterStyle.FORM,
    schema=SerialNumSchema,
    required=True,
    explode=True,
)
_auth = [
...
SchemaFor200ResponseBodyApplicationJson = RetrieveSystemIdResponse
...
class RetrieveSystemId(BaseApi):
    ...
    def retrieve_system_id(
        ...
        return self._retrieve_system_id_oapg(
