...
# Query params
EndAtSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'end_at': typing.Union[EndAtSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = GetSystemProductionMeterReadingsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_production_meter_readings_oapg(
        self,
...
class GetSystemProductionMeterReadings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_production_meter_readings(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_system_production_meter_readings(
        ...
        return self._get_system_production_meter_readings_oapg(
