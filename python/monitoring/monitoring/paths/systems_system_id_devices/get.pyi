...
SchemaFor200ResponseBodyApplicationJson = GetSystemDevicesResponse
...
class GetSystemDevices(BaseApi):
    ...
    def get_system_devices(
        ...
        return self._get_system_devices_oapg(
