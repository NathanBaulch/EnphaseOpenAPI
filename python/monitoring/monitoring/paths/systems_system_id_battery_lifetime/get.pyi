...
SchemaFor200ResponseBodyApplicationJson = GetSystemBatteryLifetimeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_battery_lifetime_oapg(
        self,
...
class GetSystemBatteryLifetime(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_battery_lifetime(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_system_battery_lifetime(
        ...
        return self._get_system_battery_lifetime_oapg(
