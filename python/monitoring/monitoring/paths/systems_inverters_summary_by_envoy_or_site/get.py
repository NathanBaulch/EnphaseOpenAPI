...
EnvoySerialNumberSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'site_id': typing.Union[SiteIdSchema, decimal.Decimal, int, ],
        'envoy_serial_number': typing.Union[EnvoySerialNumberSchema, str, ],
    },
    total=False
)
...
request_query_envoy_serial_number = api_client.QueryParameter(
    name="envoy_serial_number",
    style=api_client.ParameterStyle.FORM,
    schema=EnvoySerialNumberSchema,
    explode=True,
)
_auth = [
    'OAuth2',
...
SchemaFor200ResponseBodyApplicationJson = GetInvertersSummaryByEnvoyOrSiteResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_inverters_summary_by_envoy_or_site_oapg(
        self,
    ...
    def _get_inverters_summary_by_envoy_or_site_oapg(
        ...
        for parameter in (
            ...
            request_query_envoy_serial_number,
        ):
...
class GetInvertersSummaryByEnvoyOrSite(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_inverters_summary_by_envoy_or_site(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_inverters_summary_by_envoy_or_site(
        ...
        return self._get_inverters_summary_by_envoy_or_site_oapg(
