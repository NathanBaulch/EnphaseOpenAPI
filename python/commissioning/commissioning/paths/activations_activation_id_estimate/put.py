...
# body param
SchemaForRequestBodyApplicationJson = UpdateActivationEstimateRequest
...
SchemaFor200ResponseBodyApplicationJson = SystemEstimate
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_activation_estimate_oapg(
        self,
...
class UpdateActivationEstimate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_activation_estimate(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_activation_estimate(
        ...
        return self._update_activation_estimate_oapg(
            body=body,
