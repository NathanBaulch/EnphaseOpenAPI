...
SchemaFor200ResponseBodyApplicationJson = GetSelfCompanyBranchesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_self_company_branches_oapg(
        self,
...
class GetSelfCompanyBranches(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_self_company_branches(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_self_company_branches(
        ...
        return self._get_self_company_branches_oapg(
