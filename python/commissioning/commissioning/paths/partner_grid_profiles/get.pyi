...
SchemaFor200ResponseBodyApplicationJson = GetGridProfilesResponse
...
class GetGridProfiles(BaseApi):
    ...
    def get_grid_profiles(
        ...
        return self._get_grid_profiles_oapg(
