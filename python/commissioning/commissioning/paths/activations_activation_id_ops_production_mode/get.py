...
SchemaFor200ResponseBodyApplicationJson = GetActivationOpsProductionModeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_activation_ops_production_mode_oapg(
        self,
...
class GetActivationOpsProductionMode(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_activation_ops_production_mode(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_activation_ops_production_mode(
        ...
        return self._get_activation_ops_production_mode_oapg(
