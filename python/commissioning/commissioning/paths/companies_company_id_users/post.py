...
# body param
SchemaForRequestBodyApplicationJson = CreateCompanyUserRequest
...
class CreateCompanyUser(BaseApi):
    ...
    def create_company_user(
        ...
        return self._create_company_user_oapg(
            body=body,
