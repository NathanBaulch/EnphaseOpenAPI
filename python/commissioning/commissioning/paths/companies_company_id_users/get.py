...
SchemaFor200ResponseBodyApplicationJson = GetCompanyUsersResponse
...
class GetCompanyUsers(BaseApi):
    ...
    def get_company_users(
        ...
        return self._get_company_users_oapg(
