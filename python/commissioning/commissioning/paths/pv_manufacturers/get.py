...
SchemaFor200ResponseBodyApplicationJson = GetPvManufacturersResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pv_manufacturers_oapg(
        self,
...
class GetPvManufacturers(BaseApi):
    ...
    def get_pv_manufacturers(
        ...
        return self._get_pv_manufacturers_oapg(
