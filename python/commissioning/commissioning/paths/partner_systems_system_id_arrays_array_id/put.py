...
ArrayIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'system_id': typing.Union[SystemIdSchema, decimal.Decimal, int, ],
        'array_id': typing.Union[ArrayIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_array_id = api_client.PathParameter(
    name="array_id",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationText = ArrayParams


request_body_params = api_client.RequestBody(
    content={
        'application/text': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationText),
    },
)
_auth = [
    'OAuth2',
...
SchemaFor404ResponseBodyApplicationJson = ServerError
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_system_array_oapg(
        self,
        content_type: typing_extensions.Literal["application/text"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationText, schemas.Unset] = schemas.unset,
    ...
    def _update_system_array_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_params.serialize(body, content_type)
...
class UpdateSystemArray(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_system_array(
        self,
        content_type: typing_extensions.Literal["application/text"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationText, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_system_array(
        ...
        return self._update_system_array_oapg(
            body=body,
