...
# Query params
OperationalDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'operational_date': typing.Union[OperationalDateSchema, str, date, ],
    },
    total=False
)
...
request_query_operational_date = api_client.QueryParameter(
    name="operational_date",
    style=api_client.ParameterStyle.FORM,
    schema=OperationalDateSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = UpdateSystemMeterResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_system_meter_oapg(
        ...
        for parameter in (
            request_query_operational_date,
        ):
...
class UpdateSystemMeter(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_system_meter(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def update_system_meter(
        ...
        return self._update_system_meter_oapg(
