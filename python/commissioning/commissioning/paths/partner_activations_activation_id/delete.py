...
SchemaFor200ResponseBodyApplicationJson = DeleteActivationResponse
...
class DeleteActivation(BaseApi):
    ...
    def delete_activation(
        ...
        return self._delete_activation_oapg(
