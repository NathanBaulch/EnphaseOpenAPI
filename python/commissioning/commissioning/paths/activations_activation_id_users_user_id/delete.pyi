...
SchemaFor200ResponseBodyApplicationJson = RevokeActivationUserAccessResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _revoke_activation_user_access_oapg(
        self,
...
class RevokeActivationUserAccess(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def revoke_activation_user_access(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def revoke_activation_user_access(
        ...
        return self._revoke_activation_user_access_oapg(
