...
SchemaFor200ResponseBodyApplicationJson = GrantActivationUserAccessResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _grant_activation_user_access_oapg(
        self,
...
class GrantActivationUserAccess(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def grant_activation_user_access(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def grant_activation_user_access(
        ...
        return self._grant_activation_user_access_oapg(
