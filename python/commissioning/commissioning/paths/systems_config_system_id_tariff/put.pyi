...
# body param
SchemaForRequestBodyApplicationText = TariffSettings
...
SchemaFor200ResponseBodyApplicationJson = UpdateSystemTariffSettingsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_system_tariff_settings_oapg(
        self,
...
class UpdateSystemTariffSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_system_tariff_settings(
        self,
        content_type: typing_extensions.Literal["application/text"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationText, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_system_tariff_settings(
        ...
        return self._update_system_tariff_settings_oapg(
            body=body,
