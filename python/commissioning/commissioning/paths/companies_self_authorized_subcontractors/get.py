...
SchemaFor200ResponseBodyApplicationJson = GetSelfCompanyAuthorizedSubcontractorsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_self_company_authorized_subcontractors_oapg(
        self,
...
class GetSelfCompanyAuthorizedSubcontractors(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_self_company_authorized_subcontractors(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_self_company_authorized_subcontractors(
        ...
        return self._get_self_company_authorized_subcontractors_oapg(
