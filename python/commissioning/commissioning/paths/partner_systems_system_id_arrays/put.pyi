...
# body param
SchemaForRequestBodyApplicationText = UpdateSystemArraysRequest
...
SchemaFor200ResponseBodyApplicationJson = SystemArrays
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_system_arrays_oapg(
        self,
...
class UpdateSystemArrays(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_system_arrays(
        self,
        content_type: typing_extensions.Literal["application/text"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationText, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_system_arrays(
        ...
        return self._update_system_arrays_oapg(
            body=body,
