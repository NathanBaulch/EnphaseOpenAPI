...
# body param
SchemaForRequestBodyApplicationJson = UpdateCompanyUserRequest
...
class UpdateCompanyUser(BaseApi):
    ...
    def update_company_user(
        ...
        return self._update_company_user_oapg(
            body=body,
