...
conf = commissioning.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "https://api.enphaseenergy.com/api/v4" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("commissioning")
