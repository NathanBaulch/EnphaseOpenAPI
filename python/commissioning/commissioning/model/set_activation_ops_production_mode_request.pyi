...
class SetActivationOpsProductionModeRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def mode() -> typing.Type['SystemProductionModeEnum']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mode"]) -> 'SystemProductionModeEnum': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mode"]) -> 'SystemProductionModeEnum': ...
