...
class SystemEstimate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "degrade_factor", "month_estimates", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["degrade_factor"]) -> typing.Union[MetaOapg.properties.degrade_factor, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["month_estimates"]) -> typing.Union[MetaOapg.properties.month_estimates, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "degrade_factor", "month_estimates", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        degrade_factor: typing.Union[MetaOapg.properties.degrade_factor, str, schemas.Unset] = schemas.unset,
        month_estimates: typing.Union[MetaOapg.properties.month_estimates, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
