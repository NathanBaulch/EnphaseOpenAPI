...
/**
 * ConsumptionStatsResponseIntervals Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConsumptionStatsResponseIntervals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsumptionStatsResponse_intervals';
     ...
     * Sets enwh
     *
     * @param int $enwh Energy consumed during this interval, in Watt-hours.
     *
     * @return self
     */
     ...
     *
     * @param int $devices_reporting Number of consumption meters that reported data for this interval at the time of the request.
     *
     * @return self
     */
