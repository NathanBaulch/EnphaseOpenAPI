...
class UnprocessableEntityError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('first_interval', $data ?? [], null);
        $this->setIfExists('last_interval', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($first_interval)) {
            throw new \InvalidArgumentException('non-nullable first_interval cannot be null');
        }
    ...
    public function setLastInterval($last_interval)
    {
        if (is_null($last_interval)) {
            throw new \InvalidArgumentException('non-nullable last_interval cannot be null');
        }
