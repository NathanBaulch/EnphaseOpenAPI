...
class InventoryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('envoys', $data ?? [], null);
        $this->setIfExists('inverters', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($envoys)) {
            throw new \InvalidArgumentException('non-nullable envoys cannot be null');
        }
    ...
    {
        if (is_null($inverters)) {
            throw new \InvalidArgumentException('non-nullable inverters cannot be null');
        }
