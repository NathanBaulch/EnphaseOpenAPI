 ...
 */
class GetGridProfilesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetGridProfilesResponse';
    ...
    {
        $this->setIfExists('grid_profiles', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['grid_profiles'];
    }
     ...
     * @return self
     */
    public function setGridProfiles($grid_profiles)
    {
        if (is_null($grid_profiles)) {
            throw new \InvalidArgumentException('non-nullable grid_profiles cannot be null');
        }
        $this->container['grid_profiles'] = $grid_profiles;
