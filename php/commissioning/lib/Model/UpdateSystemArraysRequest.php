 ...
 */
class UpdateSystemArraysRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSystemArraysRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['arrays'] === null) {
            $invalidProperties[] = "'arrays' can't be null";
        }
     ...
     * Sets angle
     *
     * @param int $angle Angle of the system.
     *
     * @return self
     */
