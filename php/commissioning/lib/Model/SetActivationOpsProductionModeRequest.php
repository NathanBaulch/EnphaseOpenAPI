 ...
 */
class SetActivationOpsProductionModeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetActivationOpsProductionModeRequest';
