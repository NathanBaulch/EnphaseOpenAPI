...
class Company implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets company_id
     *
     * @param int|null $company_id Enlighten-generated ID of the company to which the user belongs.
     *
     * @return self
     */
     ...
     * Sets company_name
     *
     * @param string|null $company_name Name of the company to which the user belongs.
     *
     * @return self
     */
