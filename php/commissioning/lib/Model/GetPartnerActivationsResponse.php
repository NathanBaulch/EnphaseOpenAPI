 ...
 */
class GetPartnerActivationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPartnerActivationsResponse';
    ...
    */
     ...
     * Sets next
     *
     * @param string|null $next If the first request does not return a full list, use the 'next' attribute in the response body to request the next page. By default, activations are returned in batches of 10. The maximum page size is 1000.
     *
     * @return self
     */
