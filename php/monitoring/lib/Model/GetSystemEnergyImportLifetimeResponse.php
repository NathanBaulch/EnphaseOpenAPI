 ...
 */
class GetSystemEnergyImportLifetimeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemEnergyImportLifetimeResponse';
    ...
    */
     ...
     * Sets import
     *
     * @param int[]|null $import An array of import measurements, one for each day since the system started producing, or one for each day of the requested period. If the system has never produced energy, the array may be empty.
     *
     * @return self
     */
