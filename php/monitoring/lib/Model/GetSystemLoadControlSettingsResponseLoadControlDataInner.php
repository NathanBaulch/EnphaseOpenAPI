...
/**
 * GetSystemLoadControlSettingsResponseLoadControlDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSystemLoadControlSettingsResponseLoadControlDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemLoadControlSettingsResponse_load_control_data_inner';
    ...
    */
     ...
     * Sets config
     *
     * @param string|null $config Enabled/disabled.
     *
     * @return self
     */
