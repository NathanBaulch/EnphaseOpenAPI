 ...
 */
class GetSystemDevicesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemDevicesResponse';
    ...
    */
     ...
     * Sets total_devices
     *
     * @param int|null $total_devices Total active devices associated with the system.
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param string|null $items List key.
     *
     * @return self
     */
