...
/**
 * GetSystemBatteryTelemetryResponseIntervalsInnerDischarge Class Doc Comment
 *
 * @category Class
 * @package  EnphaseOpenAPI\Monitoring
 * @author   OpenAPI Generator team
 ...
 */
class GetSystemBatteryTelemetryResponseIntervalsInnerDischarge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemBatteryTelemetryResponse_intervals_inner_discharge';
    ...
    */
     ...
     * Sets enwh
     *
     * @param int|null $enwh Energy discharged from the battery during the interval.
     *
     * @return self
     */
