 ...
 */
class GetSystemEnergyExportTelemetryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemEnergyExportTelemetryResponse';
