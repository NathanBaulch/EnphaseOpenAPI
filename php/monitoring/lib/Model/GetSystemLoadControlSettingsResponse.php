 ...
 */
class GetSystemLoadControlSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemLoadControlSettingsResponse';
