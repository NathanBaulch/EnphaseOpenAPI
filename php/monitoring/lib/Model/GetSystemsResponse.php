 ...
 */
class GetSystemsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemsResponse';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Total number of systems.
     *
     * @return self
     */
     ...
     * Sets current_page
     *
     * @param int|null $current_page Number of the current page fetched.
     *
     * @return self
     */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling GetSystemsResponse., must be smaller than or equal to 100.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling GetSystemsResponse., must be bigger than or equal to 1.');
        }
