...
/**
 * GetSystemRgmStatsResponseIntervalsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSystemRgmStatsResponseIntervalsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemRgmStatsResponse_intervals_inner';
    ...
    */
     ...
     *
     * @param int|null $devices_reporting Number of revenue-grade meters that reported data for this interval at the time of the request.
     *
     * @return self
     */
     ...
     * Sets wh_del
     *
     * @param int|null $wh_del Energy delivered during this interval, in Wh.
     *
     * @return self
     */
