...
/**
 * GetSystemGridStatusSettingsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSystemGridStatusSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSystemGridStatusSettingsResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('grid_state', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['grid_state'];
    }
     ...
     * @return self
     */
    public function setGridState($grid_state)
    {
        if (is_null($grid_state)) {
            throw new \InvalidArgumentException('non-nullable grid_state cannot be null');
        }
        $this->container['grid_state'] = $grid_state;
